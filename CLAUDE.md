...
6. **App E2E** — Add **desktop E2E** specs where the feature is user-visible (`yarn test:e2e*`, isolated workspace — see [Testing & E2E](#testing--e2e) above) so the full stack (UI → Tauri → sidecar) behaves as intended.
