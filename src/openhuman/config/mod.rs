...
pub use schema::{
    ...
    LarkConfig, LearningConfig, LocalAiConfig, MatrixConfig, MemoryConfig, ModelRouteConfig,
    MultimodalConfig, ObservabilityConfig, OrchestratorConfig, PeripheralBoardConfig,
    ...
    UpdateConfig, VoiceActivationMode, VoiceServerConfig, WebSearchConfig, WebhookConfig,
    DEFAULT_MODEL, MODEL_AGENTIC_V1, MODEL_CODING_V1, MODEL_REASONING_V1,
};
pub use schema::{
