            ...
            <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-soft">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl font-semibold text-stone-900">
                  Invite people into OpenHuman
                </h1>
                <p className="max-w-xl text-sm text-stone-600">
                  Share your referral link, track your progress, and keep any active coupon rewards
                  in one place.
                </p>
              </div>
            </div>
          ...
          <>
            ...
            {error ? (
              <div
                ...
                Rewards sync is unavailable right now. The page is showing connection guidance
                without claiming new unlocks. Details: {error}
              </div>
            ) : null}
