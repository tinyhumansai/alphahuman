...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Registres du Core',
  'home.coreRegistriesDescription':
    'Inspectez les enregistrements exacts des agents, outils et connecteurs dans Core.',
  'home.coreRegistriesBlockedTitle': 'Intégration Core requise',
  'home.coreRegistriesBlockedMissingDescription':
    'Terminez intégration Core sur bureau avant inspection des registres.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Réparez intégration Core sur bureau avant inspection des registres.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Reconnectez le pont local du Core avant inspection des registres.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Reconnectez-vous à Internet avant inspection des registres.',
  'registries.page.eyebrow': 'Vues du registre',
  'registries.page.title': 'Registres du Core',
  'registries.page.description':
    'Inspection en lecture seule des enregistrements exacts des agents, outils et connecteurs fournis par Core.',
  ...
  'registries.summaryState.loading': 'Chargement',
  'registries.summaryState.fresh': 'Récent',
  'registries.summaryState.stale': 'Périmé',
  'registries.summaryState.partial': 'Partiel',
  'registries.summaryState.blocked': 'Bloqué',
  'registries.summaryState.observed': 'Observé',
  'registries.blocker.configRequiredTitle': 'Intégration Core requise',
  'registries.blocker.configMissingDescription':
    'Aucune configuration intégration Core trouvée pour inspection des registres.',
  'registries.blocker.configInvalidTitle': 'Intégration Core invalide',
  'registries.blocker.configInvalidDescription':
    'La configuration intégration Core actuelle est invalide pour inspection des registres.',
  'registries.blocker.authRequiredTitle': 'Authentification Core requise',
  'registries.blocker.authRequiredDescription':
    'Inspection du registre non authentifiée auprès du Core pour cette session.',
  'registries.blocker.forbiddenTitle': 'Inspection du registre interdite',
  'registries.blocker.forbiddenDescription':
    'Core a rejeté cet acteur pour inspection des registres du tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant indisponible',
  'registries.blocker.tenantUnavailableDescription':
    'Core a signalé que ce tenant est temporairement indisponible pour inspection du registre.',
  'registries.blocker.tenantInvariantTitle': 'Violation invariant tenant',
  'registries.blocker.tenantInvariantDescription':
    'Core a signalé une violation invariant tenant pour inspection du registre.',
  'registries.blocker.genericDescription':
    'Intégration Core bloque actuellement inspection du registre.',
  ...
  'registries.collections.toolDefinitions.title': 'Définitions',
  'registries.collections.toolDefinitions.description':
    'Contrats outils publiés, distincts des activations de permission.',
  'registries.collections.toolDefinitions.loadMore': 'Charger plus définitions',
  ...
  'registries.collections.connectorBindings.title': 'Liaisons',
  'registries.collections.connectorBindings.description':
    'Comptes fournisseur liés et sélections de capacités.',
  'registries.collections.connectorBindings.loadMore': 'Charger plus liaisons',
  'registries.items.created': 'Créé {date}',
  'registries.items.fingerprint.config': 'Empreinte configuration {fingerprint}',
  'registries.items.fingerprint.definition': 'Définition fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Empreinte type {fingerprint}',
  'registries.items.fingerprint.binding': 'Liaison fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'Aucun mode audit',
  'registries.items.meta.approvalRequired': 'Approbation requise',
  'registries.items.meta.noApprovalGate': 'Aucune porte approbation',
  'registries.items.status.noTenantEnablement': 'Aucune activation tenant renvoyée',
  'registries.live.blocked': 'Alerte : {title}. {description}',
  'registries.live.loaded': 'Onglet {tab} actif. {key} version {version} sélectionné.',
  'registries.live.loading': 'Onglet {tab} actif. Chargement {key} version {version}.',
  'registries.live.idle': 'Onglet {tab} actif. Aucun détail sélectionné.',
  'registries.drawer.title': 'Détail du registre',
  'registries.drawer.eyebrow': 'Détail du registre',
  'registries.collection.state.idle': 'Au repos',
  'registries.collection.state.loading': 'Chargement',
  'registries.collection.state.observed': 'Observé',
  'registries.collection.state.stale': 'Périmé',
  'registries.collection.state.blocked': 'Bloqué',
  'registries.collection.body.idle': 'En attente de la première observation.',
  'registries.collection.body.loading': 'Actualisation des enregistrements exacts depuis Core.',
  'registries.collection.body.empty': 'Observation terminée sans enregistrement renvoyé.',
  'registries.collection.body.observedAt': 'Observé à {observedAt}.',
  'registries.collection.body.stale':
    'Observé à {observedAt}; le dernier rafraîchissement a conservé les dernières données valides.',
  'registries.collection.body.blocked': 'Core a rejeté cette collection pour inspection.',
  'registries.collection.empty':
    'Aucun enregistrement exact disponible dans cette collection pour le moment.',
  'registries.detail.notAvailable': 'Non disponible',
  'registries.detail.copyFingerprint': 'Copier empreinte complète',
  'registries.detail.emptySchemaObject': 'Objet schéma vide',
  'registries.detail.schemaType': 'Type : {type}',
  'registries.detail.schemaProperties': '{count} propriétés',
  'registries.detail.schemaRequired': '{count} requises',
  'registries.detail.noFields': 'Aucun champ',
  'registries.detail.fieldsSampleMore': '{count} champs · {sample}…',
  'registries.detail.fieldsSample': '{count} champs · {sample}',
  'registries.detail.noNormalizationContracts': 'Aucun contrat normalisation',
  'registries.detail.unresolved': 'Non résolu: {label}',
  'registries.detail.deferred': 'Chargez onglet cible pour inspecter {label}.',
  'registries.detail.fingerprint.configuration': 'Empreinte configuration',
  'registries.detail.fingerprint.definition': 'Empreinte définition',
  'registries.detail.fingerprint.connectorType': 'Empreinte type connecteur',
  'registries.detail.fingerprint.binding': 'Empreinte liaison',
  ...
  'registries.detail.section.definitionLink': 'Lien définition',
  'registries.detail.section.typeLifecycle': 'Cycle type',
  'registries.detail.section.contracts': 'Contrats',
  'registries.detail.section.bindingLifecycle': 'Cycle liaison',
  'registries.detail.section.exactConnectorType': 'Type connecteur exact',
  'registries.detail.section.logicalReferences': 'Références logiques',
  'registries.detail.note.activeRecords':
    'Les enregistrements actifs sont des états publication, pas des permissions exécution.',
  'registries.detail.noExactToolRefs': 'Aucune référence outil exacte déclarée.',
  'registries.detail.note.logicalReferenceWarnings':
    'Références logiques nécessitent un suivi hors de cette vue lecture seule.',
  'registries.detail.field.lifecycle': 'Cycle',
  'registries.detail.field.owner': 'Propriétaire',
  'registries.detail.field.created': 'Créé',
  'registries.detail.field.knowledgeScopes': 'Portées connaissance',
  'registries.detail.field.riskPolicy': 'Politique risque',
  'registries.detail.none': 'Aucun',
  'registries.detail.field.effectClass': 'Classe effet',
  'registries.detail.field.schemaVersion': 'Version schéma',
  'registries.detail.field.enablement': 'Activation',
  'registries.detail.field.inputSchema': 'Schéma entrée',
  'registries.detail.field.outputSchema': 'Schéma sortie',
  'registries.detail.field.timeoutDefaults': 'Délais par défaut',
  'registries.detail.field.retryContract': 'Contrat retry',
  'registries.detail.field.auditContract': 'Contrat audit',
  'registries.detail.viewRawJson': 'Voir JSON brut',
  'registries.detail.field.generation': 'Génération',
  'registries.detail.field.approvalRequired': 'Approbation requise',
  'registries.detail.field.auditMode': 'Mode audit',
  'registries.detail.notSet': 'Non défini',
  'registries.detail.field.timeoutCap': 'Plafond délai',
  'registries.detail.field.allowTtl': 'TTL autorisé',
  'registries.detail.field.updated': 'Mis à jour',
  'registries.detail.note.enablementRecords':
    'Les activations expriment les garde-fous de permission, pas état publication de la définition.',
  'registries.detail.field.sourceType': 'Type source',
  'registries.detail.field.capabilities': 'Capacités',
  'registries.detail.field.normalizationContracts': 'Contrats normalisation',
  'registries.detail.field.deliveryBehavior': 'Comportement livraison',
  'registries.detail.field.providerAccountReference': 'Référence compte fournisseur',
  'registries.detail.note.logicalReferencesSecret':
    'Référence logique uniquement; secret non affiché.',
  'registries.detail.field.configReference': 'Référence configuration',
  'registries.detail.field.credentialReference': 'Référence identifiant',
  'registries.detail.empty': 'Sélectionnez un enregistrement pour inspecter sa version exacte.',
  'registries.detail.state.loading': 'Chargement du détail exact du registre...',
  ...
  'registries.detail.kind.connector-binding': 'Liaison connecteur',
