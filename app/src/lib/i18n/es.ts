...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Registros del Core',
  'home.coreRegistriesDescription':
    'Inspecciona registros exactos de agentes, herramientas y conectores desde Core.',
  'home.coreRegistriesBlockedTitle': 'Integración con Core obligatoria',
  'home.coreRegistriesBlockedMissingDescription':
    'Completa la integración de Core en escritorio antes de inspeccionar los registros.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Repara la integración de Core en escritorio antes de inspeccionar los registros.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Vuelve a conectar el puente local con Core antes de inspeccionar los registros.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Vuelve a conectarte a internet antes de inspeccionar los registros.',
  'registries.page.eyebrow': 'Vistas del registro',
  'registries.page.title': 'Registros del Core',
  'registries.page.description':
    'Inspección de solo lectura de registros exactos de agentes, herramientas y conectores respaldados por Core.',
  'registries.page.readOnly':
    'Esta pantalla nunca escribe configuración, secretos ni estado de ejecución.',
  'registries.page.retry': 'Reintentar',
  'registries.page.tablistAria': 'Registros del Core',
  'registries.tab.agents': 'Agentes',
  'registries.tab.tools': 'Herramientas',
  'registries.tab.connectors': 'Conectores',
  'registries.summaryState.idle': 'Inactivo',
  'registries.summaryState.loading': 'Cargando',
  'registries.summaryState.fresh': 'Reciente',
  'registries.summaryState.stale': 'Desactualizado',
  'registries.summaryState.partial': 'Parcial',
  'registries.summaryState.blocked': 'Bloqueado',
  'registries.summaryState.observed': 'Observado',
  'registries.blocker.configRequiredTitle': 'Integración con Core obligatoria',
  'registries.blocker.configMissingDescription':
    'No se encontró configuración de integración con Core para inspeccionar registros.',
  'registries.blocker.configInvalidTitle': 'Integración con Core no válida',
  'registries.blocker.configInvalidDescription':
    'La configuración actual de integración con Core no es válida para inspeccionar registros.',
  'registries.blocker.authRequiredTitle': 'Autenticación con Core obligatoria',
  'registries.blocker.authRequiredDescription':
    'La inspección del registro no pudo autenticarse con Core en esta sesión.',
  'registries.blocker.forbiddenTitle': 'Inspección del registro prohibida',
  'registries.blocker.forbiddenDescription':
    'Core rechazó este actor para la inspección de registros del tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant no disponible',
  'registries.blocker.tenantUnavailableDescription':
    'Core informó que este tenant no está disponible temporalmente para la inspección del registro.',
  'registries.blocker.tenantInvariantTitle': 'Violación de invariante del tenant',
  'registries.blocker.tenantInvariantDescription':
    'Core informó una violación de invariante del tenant para la inspección del registro.',
  'registries.blocker.genericDescription':
    'La integración con Core está bloqueando actualmente la inspección del registro.',
  'registries.blocker.readOnly':
    'Esta pantalla es de solo lectura y no puede escribir configuración por ti.',
  'registries.blocker.fixFlow':
    'Corrige la conexión con Core en el flujo de integración existente y vuelve a intentarlo aquí.',
  'registries.collections.agents.title': 'Agentes',
  'registries.collections.agents.description':
    'Registros publicados de agentes. Ningún registro se selecciona automáticamente.',
  'registries.collections.agents.loadMore': 'Cargar más agentes',
  'registries.collections.toolDefinitions.title': 'Definiciones',
  'registries.collections.toolDefinitions.description':
    'Contratos de herramientas publicados, separados de las habilitaciones de permisos.',
  'registries.collections.toolDefinitions.loadMore': 'Cargar más definiciones',
  'registries.collections.toolEnablements.title': 'Habilitaciones',
  'registries.collections.toolEnablements.description':
    'Puertas de permisos y límites de aprobación en tiempo de ejecución para herramientas.',
  'registries.collections.connectorTypes.title': 'Tipos',
  'registries.collections.connectorTypes.description':
    'Tipos de conectores publicados y contratos de normalización.',
  'registries.collections.connectorTypes.loadMore': 'Cargar más tipos',
  'registries.collections.connectorBindings.title': 'Vinculaciones',
  'registries.collections.connectorBindings.description':
    'Cuentas de proveedor vinculadas y selecciones de capacidades.',
  'registries.collections.connectorBindings.loadMore': 'Cargar más vinculaciones',
  'registries.items.created': 'Creado {date}',
  'registries.items.fingerprint.config': 'Huella de configuración {fingerprint}',
  'registries.items.fingerprint.definition': 'Definición fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Tipo fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Vinculación fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'Sin modo de auditoría',
  'registries.items.meta.approvalRequired': 'Aprobación obligatoria',
  'registries.items.meta.noApprovalGate': 'Sin puerta de aprobación',
  'registries.items.status.noTenantEnablement': 'No se devolvió habilitación del tenant',
  'registries.live.blocked': 'Aviso: {title}. {description}',
  'registries.live.loaded': 'Pestaña {tab} activa. Se seleccionó {key} versión {version}.',
  'registries.live.loading': 'Pestaña {tab} activa. Cargando {key} versión {version}.',
  'registries.live.idle': 'Pestaña {tab} activa. No hay detalle seleccionado.',
  'registries.drawer.title': 'Detalle del registro',
  'registries.drawer.eyebrow': 'Detalle del registro',
  'registries.collection.state.idle': 'Inactivo',
  'registries.collection.state.loading': 'Cargando',
  'registries.collection.state.observed': 'Observado',
  'registries.collection.state.stale': 'Desactualizado',
  'registries.collection.state.blocked': 'Bloqueado',
  'registries.collection.body.idle': 'Esperando la primera observación.',
  'registries.collection.body.loading': 'Actualizando los registros exactos desde Core.',
  'registries.collection.body.empty': 'Se observó la colección sin registros devueltos.',
  'registries.collection.body.observedAt': 'Observado en {observedAt}.',
  'registries.collection.body.stale':
    'Observado en {observedAt}; la última actualización conservó los últimos datos válidos.',
  'registries.collection.body.blocked': 'Core rechazó esta colección para la inspección.',
  'registries.collection.empty': 'Todavía no hay registros exactos disponibles en esta colección.',
  'registries.detail.notAvailable': 'No disponible',
  'registries.detail.copyFingerprint': 'Copiar huella completa',
  'registries.detail.emptySchemaObject': 'Objeto de esquema vacío',
  'registries.detail.schemaType': 'Tipo {type}',
  'registries.detail.schemaProperties': '{count} propiedades',
  'registries.detail.schemaRequired': '{count} obligatorias',
  'registries.detail.noFields': 'Sin campos',
  'registries.detail.fieldsSampleMore': '{count} campos · {sample}…',
  'registries.detail.fieldsSample': '{count} campos · {sample}',
  'registries.detail.noNormalizationContracts': 'Sin contratos de normalización',
  'registries.detail.unresolved': 'Sin resolver: {label}',
  'registries.detail.deferred': 'Carga la pestaña de destino para inspeccionar {label}.',
  'registries.detail.fingerprint.configuration': 'Huella de configuración',
  'registries.detail.fingerprint.definition': 'Huella de definición',
  'registries.detail.fingerprint.connectorType': 'Huella del tipo de conector',
  'registries.detail.fingerprint.binding': 'Huella de vinculación',
  'registries.detail.section.agentLifecycle': 'Ciclo de vida del agente',
  'registries.detail.section.exactToolReferences': 'Referencias exactas de herramientas',
  'registries.detail.section.logicalReferenceWarnings': 'Advertencias de referencias lógicas',
  'registries.detail.section.configuration': 'Configuración',
  'registries.detail.section.definitionLifecycle': 'Ciclo de vida de la definición',
  'registries.detail.section.schemas': 'Esquemas',
  'registries.detail.section.enablementLifecycle': 'Ciclo de vida de la habilitación',
  'registries.detail.section.definitionLink': 'Enlace de la definición',
  'registries.detail.section.typeLifecycle': 'Ciclo de vida del tipo',
  'registries.detail.section.contracts': 'Contratos',
  'registries.detail.section.bindingLifecycle': 'Ciclo de vida de la vinculación',
  'registries.detail.section.exactConnectorType': 'Tipo exacto de conector',
  'registries.detail.section.logicalReferences': 'Referencias lógicas',
  'registries.detail.note.activeRecords':
    'Los registros activos son estados de publicación, no concesiones de permisos en tiempo de ejecución.',
  'registries.detail.noExactToolRefs': 'No se declararon referencias exactas de herramientas.',
  'registries.detail.note.logicalReferenceWarnings':
    'Las referencias lógicas requieren seguimiento fuera de esta vista de solo lectura.',
  'registries.detail.field.lifecycle': 'Ciclo de vida',
  'registries.detail.field.owner': 'Propietario',
  'registries.detail.field.created': 'Creado',
  'registries.detail.field.knowledgeScopes': 'Ámbitos de conocimiento',
  'registries.detail.field.riskPolicy': 'Política de riesgo',
  'registries.detail.none': 'Ninguno',
  'registries.detail.field.effectClass': 'Clase de efecto',
  'registries.detail.field.schemaVersion': 'Versión del esquema',
  'registries.detail.field.enablement': 'Habilitación',
  'registries.detail.field.inputSchema': 'Esquema de entrada',
  'registries.detail.field.outputSchema': 'Esquema de salida',
  'registries.detail.field.timeoutDefaults': 'Tiempos de espera predeterminados',
  'registries.detail.field.retryContract': 'Contrato de reintento',
  'registries.detail.field.auditContract': 'Contrato de auditoría',
  'registries.detail.viewRawJson': 'Ver JSON bruto',
  'registries.detail.field.generation': 'Generación',
  'registries.detail.field.approvalRequired': 'Aprobación obligatoria',
  'registries.detail.field.auditMode': 'Modo de auditoría',
  'registries.detail.notSet': 'Sin establecer',
  'registries.detail.field.timeoutCap': 'Límite de espera',
  'registries.detail.field.allowTtl': 'TTL permitido',
  'registries.detail.field.updated': 'Actualizado',
  'registries.detail.note.enablementRecords':
    'Los registros de habilitación expresan puertas de permisos, no el estado de publicación de la definición.',
  'registries.detail.field.sourceType': 'Tipo de origen',
  'registries.detail.field.capabilities': 'Capacidades',
  'registries.detail.field.normalizationContracts': 'Contratos de normalización',
  'registries.detail.field.deliveryBehavior': 'Comportamiento de entrega',
  'registries.detail.field.providerAccountReference': 'Referencia de cuenta del proveedor',
  'registries.detail.note.logicalReferencesSecret':
    'Solo referencia lógica; el secreto no se muestra.',
  'registries.detail.field.configReference': 'Referencia de configuración',
  'registries.detail.field.credentialReference': 'Referencia de credencial',
  'registries.detail.empty':
    'Selecciona un registro para inspeccionar su versión exacta del registro.',
  'registries.detail.state.loading': 'Cargando detalle exacto del registro...',
  'registries.detail.state.missing':
    'Core informó que esta versión exacta del registro ya no existe.',
  'registries.detail.state.error': 'Core no pudo cargar este registro exacto en este momento.',
  'registries.detail.kind.agent': 'Agente',
  'registries.detail.kind.tool-definition': 'Definición de herramienta',
  'registries.detail.kind.tool-enablement': 'Habilitación de herramienta',
  'registries.detail.kind.connector-type': 'Tipo de conector',
  'registries.detail.kind.connector-binding': 'Vinculación de conector',
