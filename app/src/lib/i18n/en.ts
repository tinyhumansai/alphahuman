...
const en: TranslationMap = {
  ...
  // Core registries
  'home.coreRegistries': 'Core Registries',
  'home.coreRegistriesDescription': 'Inspect exact Agent, Tool, and Connector records from Core.',
  'home.coreRegistriesBlockedTitle': 'Core integration required',
  'home.coreRegistriesBlockedMissingDescription':
    'Complete the desktop Core integration before inspecting registries.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Repair the desktop Core integration before inspecting registries.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Reconnect the local Core bridge before inspecting registries.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Reconnect to the internet before inspecting registries.',
  'registries.page.eyebrow': 'Registry Views',
  'registries.page.title': 'Core Registries',
  'registries.page.description':
    'Read-only inspection for exact agent, tool, and connector records backed by Core.',
  'registries.page.readOnly': 'This screen never writes configuration, secrets, or runtime state.',
  'registries.page.retry': 'Retry',
  'registries.page.tablistAria': 'Core registries',
  'registries.tab.agents': 'Agents',
  'registries.tab.tools': 'Tools',
  'registries.tab.connectors': 'Connectors',
  'registries.summaryState.idle': 'Idle',
  'registries.summaryState.loading': 'Loading',
  'registries.summaryState.fresh': 'Fresh',
  'registries.summaryState.stale': 'Stale',
  'registries.summaryState.partial': 'Partial',
  'registries.summaryState.blocked': 'Blocked',
  'registries.summaryState.observed': 'Observed',
  'registries.blocker.configRequiredTitle': 'Core integration required',
  'registries.blocker.configMissingDescription':
    'No Core integration configuration was found for registry inspection.',
  'registries.blocker.configInvalidTitle': 'Core integration invalid',
  'registries.blocker.configInvalidDescription':
    'The current Core integration configuration is invalid for registry inspection.',
  'registries.blocker.authRequiredTitle': 'Core authentication required',
  'registries.blocker.authRequiredDescription':
    'Registry inspection could not authenticate with Core for this session.',
  'registries.blocker.forbiddenTitle': 'Registry inspection forbidden',
  'registries.blocker.forbiddenDescription':
    'Core rejected this actor for tenant registry inspection.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant unavailable',
  ...
  'registries.blocker.tenantInvariantTitle': 'Tenant invariant violation',
  ...
  'registries.blocker.genericDescription':
    'Core integration is currently blocking registry inspection.',
  'registries.blocker.readOnly': 'This screen is read-only and cannot write configuration for you.',
  ...
  'registries.collections.agents.loadMore': 'Load more agents',
  'registries.collections.toolDefinitions.title': 'Definitions',
  'registries.collections.toolDefinitions.description':
    'Published tool contracts, distinct from permission enablements.',
  'registries.collections.toolDefinitions.loadMore': 'Load more definitions',
  'registries.collections.toolEnablements.title': 'Enablements',
  ...
  'registries.collections.connectorTypes.description':
    'Published connector types and normalization contracts.',
  'registries.collections.connectorTypes.loadMore': 'Load more types',
  'registries.collections.connectorBindings.title': 'Bindings',
  'registries.collections.connectorBindings.description':
    'Bound provider accounts and capability selections.',
  'registries.collections.connectorBindings.loadMore': 'Load more bindings',
  'registries.items.created': 'Created {date}',
  'registries.items.fingerprint.config': 'Config fp:{fingerprint}',
  'registries.items.fingerprint.definition': 'Definition fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Type fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Binding fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'No audit mode',
  'registries.items.meta.approvalRequired': 'Approval required',
  'registries.items.meta.noApprovalGate': 'No approval gate',
  'registries.items.status.noTenantEnablement': 'No tenant enablement returned',
  'registries.live.blocked': '{title}. {description}',
  'registries.live.loaded': '{tab} tab active. Selected {key} version {version}.',
  'registries.live.loading': '{tab} tab active. Loading {key} version {version}.',
  'registries.live.idle': '{tab} tab active. No detail selected.',
  'registries.drawer.title': 'Registry detail',
  'registries.drawer.eyebrow': 'Registry Detail',
  'registries.collection.state.idle': 'Idle',
  'registries.collection.state.loading': 'Loading',
  'registries.collection.state.observed': 'Observed',
  'registries.collection.state.stale': 'Stale',
  'registries.collection.state.blocked': 'Blocked',
  'registries.collection.body.idle': 'Waiting for the first observation.',
  'registries.collection.body.loading': 'Refreshing the exact records from Core.',
  'registries.collection.body.empty': 'Observed with no records returned.',
  'registries.collection.body.observedAt': 'Observed at {observedAt}.',
  'registries.collection.body.stale':
    'Observed at {observedAt}; the latest refresh kept the last good data.',
  'registries.collection.body.blocked': 'Core rejected this collection for inspection.',
  'registries.collection.empty': 'No exact records available in this collection yet.',
  'registries.detail.notAvailable': 'Not available',
  'registries.detail.copyFingerprint': 'Copy full fingerprint',
  'registries.detail.emptySchemaObject': 'Empty schema object',
  'registries.detail.schemaType': 'Type {type}',
  'registries.detail.schemaProperties': '{count} properties',
  'registries.detail.schemaRequired': '{count} required',
  'registries.detail.noFields': 'No fields',
  'registries.detail.fieldsSampleMore': '{count} fields · {sample}…',
  'registries.detail.fieldsSample': '{count} fields · {sample}',
  'registries.detail.noNormalizationContracts': 'No normalization contracts',
  'registries.detail.unresolved': 'Unresolved: {label}',
  'registries.detail.deferred': 'Load the target tab to inspect {label}.',
  'registries.detail.fingerprint.configuration': 'Configuration fingerprint',
  'registries.detail.fingerprint.definition': 'Definition fingerprint',
  'registries.detail.fingerprint.connectorType': 'Connector type fingerprint',
  'registries.detail.fingerprint.binding': 'Binding fingerprint',
  'registries.detail.section.agentLifecycle': 'Agent lifecycle',
  'registries.detail.section.exactToolReferences': 'Exact tool references',
  'registries.detail.section.logicalReferenceWarnings': 'Logical reference warnings',
  'registries.detail.section.configuration': 'Configuration',
  'registries.detail.section.definitionLifecycle': 'Definition lifecycle',
  'registries.detail.section.schemas': 'Schemas',
  'registries.detail.section.enablementLifecycle': 'Enablement lifecycle',
  'registries.detail.section.definitionLink': 'Definition link',
  'registries.detail.section.typeLifecycle': 'Type lifecycle',
  'registries.detail.section.contracts': 'Contracts',
  'registries.detail.section.bindingLifecycle': 'Binding lifecycle',
  'registries.detail.section.exactConnectorType': 'Exact connector type',
  'registries.detail.section.logicalReferences': 'Logical references',
  'registries.detail.note.activeRecords':
    'Active records are publish states, not runtime permission grants.',
  'registries.detail.noExactToolRefs': 'No exact tool references are declared.',
  'registries.detail.note.logicalReferenceWarnings':
    'Logical references need follow-up outside this read-only view.',
  'registries.detail.field.lifecycle': 'Lifecycle',
  'registries.detail.field.owner': 'Owner',
  'registries.detail.field.created': 'Created',
  'registries.detail.field.knowledgeScopes': 'Knowledge scopes',
  'registries.detail.field.riskPolicy': 'Risk policy',
  'registries.detail.none': 'None',
  'registries.detail.field.effectClass': 'Effect class',
  'registries.detail.field.schemaVersion': 'Schema version',
  'registries.detail.field.enablement': 'Enablement',
  'registries.detail.field.inputSchema': 'Input schema',
  'registries.detail.field.outputSchema': 'Output schema',
  'registries.detail.field.timeoutDefaults': 'Timeout defaults',
  'registries.detail.field.retryContract': 'Retry contract',
  'registries.detail.field.auditContract': 'Audit contract',
  'registries.detail.viewRawJson': 'View raw JSON',
  'registries.detail.field.generation': 'Generation',
  'registries.detail.field.approvalRequired': 'Approval required',
  'registries.detail.field.auditMode': 'Audit mode',
  'registries.detail.notSet': 'Not set',
  'registries.detail.field.timeoutCap': 'Timeout cap',
  'registries.detail.field.allowTtl': 'Allow TTL',
  'registries.detail.field.updated': 'Updated',
  'registries.detail.note.enablementRecords':
    'Enablement records express permission gates, not definition publication state.',
  'registries.detail.field.sourceType': 'Source type',
  'registries.detail.field.capabilities': 'Capabilities',
  'registries.detail.field.normalizationContracts': 'Normalization contracts',
  'registries.detail.field.deliveryBehavior': 'Delivery behavior',
  'registries.detail.field.providerAccountReference': 'Provider account reference',
  'registries.detail.note.logicalReferencesSecret': 'Logical reference only; secret not displayed.',
  'registries.detail.field.configReference': 'Config reference',
  'registries.detail.field.credentialReference': 'Credential reference',
  'registries.detail.empty': 'Select a record to inspect its exact registry version.',
  'registries.detail.state.loading': 'Loading exact registry detail...',
  'registries.detail.state.missing':
    'Core reported that this exact record version no longer exists.',
  'registries.detail.state.error': 'Core could not load this exact record right now.',
  'registries.detail.kind.agent': 'Agent',
  'registries.detail.kind.tool-definition': 'Tool Definition',
  'registries.detail.kind.tool-enablement': 'Tool Enablement',
  'registries.detail.kind.connector-type': 'Connector Type',
  'registries.detail.kind.connector-binding': 'Connector Binding',
  // Chat: agent-generated artifacts (#2779)
