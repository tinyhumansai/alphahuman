...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Реестры Core',
  'home.coreRegistriesDescription': 'Проверяйте точные записи Agent, Tool и Connector из Core.',
  'home.coreRegistriesBlockedTitle': 'Требуется интеграция Core',
  'home.coreRegistriesBlockedMissingDescription':
    'Завершите интеграцию Core на компьютере перед проверкой реестров.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Исправьте интеграцию Core на компьютере перед проверкой реестров.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Повторно подключите локальный мост Core перед проверкой реестров.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Снова подключитесь к интернету перед проверкой реестров.',
  'registries.page.eyebrow': 'Просмотр реестра',
  'registries.page.title': 'Реестры Core',
  'registries.page.description':
    'Режим только для чтения для точных записей Agent, Tool и Connector из Core.',
  'registries.page.readOnly':
    'Этот экран никогда не записывает конфигурацию, секреты или состояние выполнения.',
  'registries.page.retry': 'Повторить',
  'registries.page.tablistAria': 'Реестры Core',
  'registries.tab.agents': 'Агенты',
  'registries.tab.tools': 'Инструменты',
  'registries.tab.connectors': 'Коннекторы',
  'registries.summaryState.idle': 'Ожидание',
  'registries.summaryState.loading': 'Загрузка',
  'registries.summaryState.fresh': 'Свежие',
  'registries.summaryState.stale': 'Устаревшие',
  'registries.summaryState.partial': 'Частично',
  'registries.summaryState.blocked': 'Заблокировано',
  'registries.summaryState.observed': 'Получено',
  'registries.blocker.configRequiredTitle': 'Требуется интеграция Core',
  'registries.blocker.configMissingDescription':
    'Не найдена конфигурация интеграции Core для проверки реестров.',
  'registries.blocker.configInvalidTitle': 'Интеграция Core недействительна',
  'registries.blocker.configInvalidDescription':
    'Текущая конфигурация интеграции Core недействительна для проверки реестров.',
  'registries.blocker.authRequiredTitle': 'Требуется аутентификация Core',
  'registries.blocker.authRequiredDescription':
    'Проверка реестра не смогла пройти аутентификацию в Core в этой сессии.',
  'registries.blocker.forbiddenTitle': 'Проверка реестра запрещена',
  'registries.blocker.forbiddenDescription':
    'Core отклонил этого участника для проверки реестров tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant недоступен',
  'registries.blocker.tenantUnavailableDescription':
    'Core сообщил, что этот tenant временно недоступен для проверки реестра.',
  'registries.blocker.tenantInvariantTitle': 'Нарушение инварианта tenant',
  'registries.blocker.tenantInvariantDescription':
    'Core сообщил о нарушении инварианта tenant при проверке реестра.',
  'registries.blocker.genericDescription': 'Интеграция Core сейчас блокирует проверку реестра.',
  'registries.blocker.readOnly':
    'Этот экран доступен только для чтения и не может записать конфигурацию за вас.',
  'registries.blocker.fixFlow':
    'Исправьте подключение Core в существующем потоке интеграции и попробуйте снова здесь.',
  'registries.collections.agents.title': 'Агенты',
  'registries.collections.agents.description':
    'Опубликованные записи агентов. Ни одна запись не выбирается автоматически.',
  'registries.collections.agents.loadMore': 'Загрузить больше агентов',
  'registries.collections.toolDefinitions.title': 'Определения',
  'registries.collections.toolDefinitions.description':
    'Опубликованные контракты инструментов, отдельно от записей включения.',
  'registries.collections.toolDefinitions.loadMore': 'Загрузить больше определений',
  'registries.collections.toolEnablements.title': 'Включения',
  'registries.collections.toolEnablements.description':
    'Шлюзы разрешений и лимиты согласования во время выполнения для инструментов.',
  'registries.collections.connectorTypes.title': 'Типы',
  'registries.collections.connectorTypes.description':
    'Опубликованные типы коннекторов и контракты нормализации.',
  'registries.collections.connectorTypes.loadMore': 'Загрузить больше типов',
  'registries.collections.connectorBindings.title': 'Привязки',
  'registries.collections.connectorBindings.description':
    'Привязанные аккаунты провайдера и выбранные возможности.',
  'registries.collections.connectorBindings.loadMore': 'Загрузить больше привязок',
  'registries.items.created': 'Создано {date}',
  'registries.items.fingerprint.config': 'Отпечаток конфигурации {fingerprint}',
  'registries.items.fingerprint.definition': 'Определение fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Тип fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Привязка fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'Режим аудита не задан',
  'registries.items.meta.approvalRequired': 'Требуется согласование',
  'registries.items.meta.noApprovalGate': 'Нет шлюза согласования',
  'registries.items.status.noTenantEnablement': 'Запись включения tenant не возвращена',
  'registries.live.blocked': 'Внимание: {title}. {description}',
  'registries.live.loaded': 'Вкладка {tab} активна. Выбрано {key} версии {version}.',
  'registries.live.loading': 'Вкладка {tab} активна. Загружается {key} версии {version}.',
  'registries.live.idle': 'Вкладка {tab} активна. Детали не выбраны.',
  'registries.drawer.title': 'Детали реестра',
  'registries.drawer.eyebrow': 'Детали реестра',
  'registries.collection.state.idle': 'Ожидание',
  'registries.collection.state.loading': 'Загрузка',
  'registries.collection.state.observed': 'Получено',
  'registries.collection.state.stale': 'Устаревшие',
  'registries.collection.state.blocked': 'Заблокировано',
  'registries.collection.body.idle': 'Ожидание первого наблюдения.',
  'registries.collection.body.loading': 'Обновляются точные записи из Core.',
  'registries.collection.body.empty': 'Наблюдение завершено, но записи не возвращены.',
  'registries.collection.body.observedAt': 'Получено в {observedAt}.',
  'registries.collection.body.stale':
    'Получено в {observedAt}; последнее обновление сохранило последние корректные данные.',
  'registries.collection.body.blocked': 'Core отклонил проверку этой коллекции.',
  'registries.collection.empty': 'В этой коллекции пока нет доступных точных записей.',
  'registries.detail.notAvailable': 'Недоступно',
  'registries.detail.copyFingerprint': 'Скопировать полный fingerprint',
  'registries.detail.emptySchemaObject': 'Пустой объект схемы',
  'registries.detail.schemaType': 'Тип {type}',
  'registries.detail.schemaProperties': '{count} свойств',
  'registries.detail.schemaRequired': '{count} обязательных',
  'registries.detail.noFields': 'Нет полей',
  'registries.detail.fieldsSampleMore': '{count} полей · {sample}…',
  'registries.detail.fieldsSample': '{count} полей · {sample}',
  'registries.detail.noNormalizationContracts': 'Нет контрактов нормализации',
  'registries.detail.unresolved': 'Не разрешено: {label}',
  'registries.detail.deferred': 'Загрузите целевую вкладку, чтобы проверить {label}.',
  'registries.detail.fingerprint.configuration': 'Fingerprint конфигурации',
  'registries.detail.fingerprint.definition': 'Fingerprint определения',
  'registries.detail.fingerprint.connectorType': 'Fingerprint типа коннектора',
  'registries.detail.fingerprint.binding': 'Fingerprint привязки',
  'registries.detail.section.agentLifecycle': 'Жизненный цикл агента',
  'registries.detail.section.exactToolReferences': 'Точные ссылки на инструменты',
  'registries.detail.section.logicalReferenceWarnings': 'Предупреждения о логических ссылках',
  'registries.detail.section.configuration': 'Конфигурация',
  'registries.detail.section.definitionLifecycle': 'Жизненный цикл определения',
  'registries.detail.section.schemas': 'Схемы',
  'registries.detail.section.enablementLifecycle': 'Жизненный цикл включения',
  'registries.detail.section.definitionLink': 'Ссылка на определение',
  'registries.detail.section.typeLifecycle': 'Жизненный цикл типа',
  'registries.detail.section.contracts': 'Контракты',
  'registries.detail.section.bindingLifecycle': 'Жизненный цикл привязки',
  'registries.detail.section.exactConnectorType': 'Точный тип коннектора',
  'registries.detail.section.logicalReferences': 'Логические ссылки',
  'registries.detail.note.activeRecords':
    'Активные записи показывают состояние публикации, а не разрешения времени выполнения.',
  'registries.detail.noExactToolRefs': 'Точные ссылки на инструменты не объявлены.',
  'registries.detail.note.logicalReferenceWarnings':
    'Логические ссылки требуют дальнейшей проверки вне этого режима только для чтения.',
  'registries.detail.field.lifecycle': 'Жизненный цикл',
  'registries.detail.field.owner': 'Владелец',
  'registries.detail.field.created': 'Создано',
  'registries.detail.field.knowledgeScopes': 'Области знаний',
  'registries.detail.field.riskPolicy': 'Политика риска',
  'registries.detail.none': 'Нет',
  'registries.detail.field.effectClass': 'Класс эффекта',
  'registries.detail.field.schemaVersion': 'Версия схемы',
  'registries.detail.field.enablement': 'Включение',
  'registries.detail.field.inputSchema': 'Схема входа',
  'registries.detail.field.outputSchema': 'Схема выхода',
  'registries.detail.field.timeoutDefaults': 'Стандартные тайм-ауты',
  'registries.detail.field.retryContract': 'Контракт повтора',
  'registries.detail.field.auditContract': 'Контракт аудита',
  'registries.detail.viewRawJson': 'Показать сырой JSON',
  'registries.detail.field.generation': 'Поколение',
  'registries.detail.field.approvalRequired': 'Требуется согласование',
  'registries.detail.field.auditMode': 'Режим аудита',
  'registries.detail.notSet': 'Не задано',
  'registries.detail.field.timeoutCap': 'Лимит тайм-аута',
  'registries.detail.field.allowTtl': 'Допустимый TTL',
  'registries.detail.field.updated': 'Обновлено',
  'registries.detail.note.enablementRecords':
    'Записи включения описывают шлюзы разрешений, а не состояние публикации определения.',
  'registries.detail.field.sourceType': 'Тип источника',
  'registries.detail.field.capabilities': 'Возможности',
  'registries.detail.field.normalizationContracts': 'Контракты нормализации',
  'registries.detail.field.deliveryBehavior': 'Поведение доставки',
  'registries.detail.field.providerAccountReference': 'Ссылка на аккаунт провайдера',
  'registries.detail.note.logicalReferencesSecret':
    'Показывается только логическая ссылка; секрет не отображается.',
  'registries.detail.field.configReference': 'Ссылка на конфигурацию',
  'registries.detail.field.credentialReference': 'Ссылка на учётные данные',
  'registries.detail.empty': 'Выберите запись, чтобы проверить её точную версию реестра.',
  'registries.detail.state.loading': 'Загружаются точные детали реестра...',
  'registries.detail.state.missing':
    'Core сообщил, что этой точной версии записи больше не существует.',
  'registries.detail.state.error': 'Core сейчас не смог загрузить эту точную запись.',
  'registries.detail.kind.agent': 'Агент',
  'registries.detail.kind.tool-definition': 'Определение инструмента',
  'registries.detail.kind.tool-enablement': 'Включение инструмента',
  'registries.detail.kind.connector-type': 'Тип коннектора',
  'registries.detail.kind.connector-binding': 'Привязка коннектора',
