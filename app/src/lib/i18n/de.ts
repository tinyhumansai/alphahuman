...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Core-Register',
  'home.coreRegistriesDescription': 'Prüfe exakte Agent-, Tool- und Connector-Einträge aus Core.',
  'home.coreRegistriesBlockedTitle': 'Core-Integration erforderlich',
  'home.coreRegistriesBlockedMissingDescription':
    'Schließe die Desktop-Core-Integration ab, bevor du Register prüfst.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Repariere die Desktop-Core-Integration, bevor du Register prüfst.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Verbinde die lokale Core-Brücke erneut, bevor du Register prüfst.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Stelle die Internetverbindung wieder her, bevor du Register prüfst.',
  'registries.page.eyebrow': 'Registeransichten',
  'registries.page.title': 'Core-Register',
  'registries.page.description':
    'Schreibgeschützte Prüfung exakter Agent-, Tool- und Connector-Einträge aus Core.',
  'registries.page.readOnly':
    'Diese Ansicht schreibt niemals Konfiguration, Geheimnisse oder Laufzeitstatus.',
  'registries.page.retry': 'Erneut versuchen',
  'registries.page.tablistAria': 'Core-Register',
  'registries.tab.agents': 'Agenten',
  'registries.tab.tools': 'Werkzeuge',
  'registries.tab.connectors': 'Konnektoren',
  'registries.summaryState.idle': 'Leerlauf',
  'registries.summaryState.loading': 'Lädt',
  'registries.summaryState.fresh': 'Aktuell',
  'registries.summaryState.stale': 'Veraltet',
  'registries.summaryState.partial': 'Teilweise',
  'registries.summaryState.blocked': 'Blockiert',
  'registries.summaryState.observed': 'Beobachtet',
  'registries.blocker.configRequiredTitle': 'Core-Integration erforderlich',
  'registries.blocker.configMissingDescription':
    'Für die Registerprüfung wurde keine Core-Integrationskonfiguration gefunden.',
  'registries.blocker.configInvalidTitle': 'Core-Integration ungültig',
  'registries.blocker.configInvalidDescription':
    'Die aktuelle Core-Integrationskonfiguration ist für die Registerprüfung ungültig.',
  'registries.blocker.authRequiredTitle': 'Core-Authentifizierung erforderlich',
  'registries.blocker.authRequiredDescription':
    'Die Registerprüfung konnte sich in dieser Sitzung nicht bei Core authentifizieren.',
  'registries.blocker.forbiddenTitle': 'Registerprüfung verboten',
  'registries.blocker.forbiddenDescription':
    'Core hat diesen Akteur für die Tenant-Registerprüfung abgelehnt.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant nicht verfügbar',
  'registries.blocker.tenantUnavailableDescription':
    'Core meldete, dass dieser Tenant für die Registerprüfung vorübergehend nicht verfügbar ist.',
  'registries.blocker.tenantInvariantTitle': 'Tenant-Invariante verletzt',
  'registries.blocker.tenantInvariantDescription':
    'Core meldete eine Verletzung der Tenant-Invariante für die Registerprüfung.',
  'registries.blocker.genericDescription':
    'Die Core-Integration blockiert derzeit die Registerprüfung.',
  'registries.blocker.readOnly':
    'Diese Ansicht ist schreibgeschützt und kann keine Konfiguration für dich schreiben.',
  'registries.blocker.fixFlow':
    'Behebe die Core-Verbindung im vorhandenen Integrationsfluss und versuche es hier erneut.',
  'registries.collections.agents.title': 'Agenten',
  'registries.collections.agents.description':
    'Veröffentlichte Agent-Einträge. Kein Eintrag wird automatisch ausgewählt.',
  'registries.collections.agents.loadMore': 'Mehr Agenten laden',
  'registries.collections.toolDefinitions.title': 'Definitionen',
  'registries.collections.toolDefinitions.description':
    'Veröffentlichte Tool-Verträge, getrennt von Berechtigungsaktivierungen.',
  'registries.collections.toolDefinitions.loadMore': 'Mehr Definitionen laden',
  'registries.collections.toolEnablements.title': 'Aktivierungen',
  'registries.collections.toolEnablements.description':
    'Berechtigungsschranken und Laufzeitfreigaben für Tools.',
  'registries.collections.connectorTypes.title': 'Typen',
  'registries.collections.connectorTypes.description':
    'Veröffentlichte Konnektortypen und Normalisierungsverträge.',
  'registries.collections.connectorTypes.loadMore': 'Mehr Typen laden',
  'registries.collections.connectorBindings.title': 'Bindungen',
  'registries.collections.connectorBindings.description':
    'Gebundene Provider-Konten und Fähigkeitsauswahl.',
  'registries.collections.connectorBindings.loadMore': 'Mehr Bindungen laden',
  'registries.items.created': 'Erstellt {date}',
  'registries.items.fingerprint.config': 'Konfigurations-Fingerprint {fingerprint}',
  'registries.items.fingerprint.definition': 'Definitions-Fingerprint {fingerprint}',
  'registries.items.fingerprint.type': 'Typ fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Bindung fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'Kein Audit-Modus',
  'registries.items.meta.approvalRequired': 'Freigabe erforderlich',
  'registries.items.meta.noApprovalGate': 'Keine Freigabeschranke',
  'registries.items.status.noTenantEnablement': 'Keine Tenant-Aktivierung zurückgegeben',
  'registries.live.blocked': 'Hinweis: {title}. {description}',
  'registries.live.loaded': 'Registerkarte {tab} aktiv. {key} Version {version} ausgewählt.',
  'registries.live.loading': 'Registerkarte {tab} aktiv. {key} Version {version} wird geladen.',
  'registries.live.idle': 'Registerkarte {tab} aktiv. Kein Detail ausgewählt.',
  'registries.drawer.title': 'Registerdetail',
  'registries.drawer.eyebrow': 'Registerdetail',
  'registries.collection.state.idle': 'Leerlauf',
  'registries.collection.state.loading': 'Lädt',
  'registries.collection.state.observed': 'Beobachtet',
  'registries.collection.state.stale': 'Veraltet',
  'registries.collection.state.blocked': 'Blockiert',
  'registries.collection.body.idle': 'Warte auf die erste Beobachtung.',
  'registries.collection.body.loading': 'Exakte Einträge werden aus Core aktualisiert.',
  'registries.collection.body.empty': 'Beobachtet, aber ohne zurückgegebene Einträge.',
  'registries.collection.body.observedAt': 'Beobachtet um {observedAt}.',
  'registries.collection.body.stale':
    'Beobachtet um {observedAt}; die letzte Aktualisierung behielt die letzten gültigen Daten.',
  'registries.collection.body.blocked': 'Core hat diese Sammlung für die Prüfung abgelehnt.',
  'registries.collection.empty': 'In dieser Sammlung sind noch keine exakten Einträge verfügbar.',
  'registries.detail.notAvailable': 'Nicht verfügbar',
  'registries.detail.copyFingerprint': 'Vollständigen Fingerabdruck kopieren',
  'registries.detail.emptySchemaObject': 'Leeres Schemaobjekt',
  'registries.detail.schemaType': 'Typ {type}',
  'registries.detail.schemaProperties': '{count} Eigenschaften',
  'registries.detail.schemaRequired': '{count} erforderlich',
  'registries.detail.noFields': 'Keine Felder',
  'registries.detail.fieldsSampleMore': '{count} Felder · {sample}…',
  'registries.detail.fieldsSample': '{count} Felder · {sample}',
  'registries.detail.noNormalizationContracts': 'Keine Normalisierungsverträge',
  'registries.detail.unresolved': 'Nicht aufgelöst: {label}',
  'registries.detail.deferred': 'Lade die Zielregisterkarte, um {label} zu prüfen.',
  'registries.detail.fingerprint.configuration': 'Konfigurations-Fingerabdruck',
  'registries.detail.fingerprint.definition': 'Definitions-Fingerabdruck',
  'registries.detail.fingerprint.connectorType': 'Konnektortyp-Fingerabdruck',
  'registries.detail.fingerprint.binding': 'Bindungs-Fingerabdruck',
  'registries.detail.section.agentLifecycle': 'Agent-Lebenszyklus',
  'registries.detail.section.exactToolReferences': 'Exakte Tool-Referenzen',
  'registries.detail.section.logicalReferenceWarnings': 'Warnungen zu logischen Referenzen',
  'registries.detail.section.configuration': 'Konfiguration',
  'registries.detail.section.definitionLifecycle': 'Definitions-Lebenszyklus',
  'registries.detail.section.schemas': 'Schemata',
  'registries.detail.section.enablementLifecycle': 'Aktivierungs-Lebenszyklus',
  'registries.detail.section.definitionLink': 'Definitions-Link',
  'registries.detail.section.typeLifecycle': 'Typ-Lebenszyklus',
  'registries.detail.section.contracts': 'Verträge',
  'registries.detail.section.bindingLifecycle': 'Bindungs-Lebenszyklus',
  'registries.detail.section.exactConnectorType': 'Exakter Konnektortyp',
  'registries.detail.section.logicalReferences': 'Logische Referenzen',
  'registries.detail.note.activeRecords':
    'Aktive Einträge sind Veröffentlichungszustände, keine Laufzeitberechtigungen.',
  'registries.detail.noExactToolRefs': 'Es wurden keine exakten Tool-Referenzen angegeben.',
  'registries.detail.note.logicalReferenceWarnings':
    'Logische Referenzen erfordern Nacharbeit außerhalb dieser schreibgeschützten Ansicht.',
  'registries.detail.field.lifecycle': 'Lebenszyklus',
  'registries.detail.field.owner': 'Besitzer',
  'registries.detail.field.created': 'Erstellt',
  'registries.detail.field.knowledgeScopes': 'Wissensbereiche',
  'registries.detail.field.riskPolicy': 'Risikorichtlinie',
  'registries.detail.none': 'Keine',
  'registries.detail.field.effectClass': 'Effektklasse',
  'registries.detail.field.schemaVersion': 'Schema-Version',
  'registries.detail.field.enablement': 'Aktivierung',
  'registries.detail.field.inputSchema': 'Eingabeschema',
  'registries.detail.field.outputSchema': 'Ausgabeschema',
  'registries.detail.field.timeoutDefaults': 'Standard-Timeouts',
  'registries.detail.field.retryContract': 'Retry-Vertrag',
  'registries.detail.field.auditContract': 'Audit-Vertrag',
  'registries.detail.viewRawJson': 'Rohes JSON anzeigen',
  'registries.detail.field.generation': 'Generationsstand',
  'registries.detail.field.approvalRequired': 'Freigabe erforderlich',
  'registries.detail.field.auditMode': 'Audit-Modus',
  'registries.detail.notSet': 'Nicht gesetzt',
  'registries.detail.field.timeoutCap': 'Timeout-Grenze',
  'registries.detail.field.allowTtl': 'Erlaubte TTL',
  'registries.detail.field.updated': 'Aktualisiert',
  'registries.detail.note.enablementRecords':
    'Aktivierungseinträge beschreiben Berechtigungsschranken, nicht den Veröffentlichungszustand der Definition.',
  'registries.detail.field.sourceType': 'Quelltyp',
  'registries.detail.field.capabilities': 'Fähigkeiten',
  'registries.detail.field.normalizationContracts': 'Normalisierungsverträge',
  'registries.detail.field.deliveryBehavior': 'Lieferverhalten',
  'registries.detail.field.providerAccountReference': 'Provider-Konto-Referenz',
  'registries.detail.note.logicalReferencesSecret':
    'Nur logische Referenz; Geheimnis wird nicht angezeigt.',
  'registries.detail.field.configReference': 'Konfigurationsreferenz',
  'registries.detail.field.credentialReference': 'Zugangsdatenreferenz',
  'registries.detail.empty': 'Wähle einen Eintrag aus, um seine exakte Registerversion zu prüfen.',
  'registries.detail.state.loading': 'Exaktes Registerdetail wird geladen...',
  'registries.detail.state.missing':
    'Core meldete, dass diese exakte Eintragsversion nicht mehr existiert.',
  'registries.detail.state.error': 'Core konnte diesen exakten Eintrag derzeit nicht laden.',
  'registries.detail.kind.agent': 'KI-Agent',
  'registries.detail.kind.tool-definition': 'Tool-Definition',
  'registries.detail.kind.tool-enablement': 'Tool-Aktivierung',
  'registries.detail.kind.connector-type': 'Konnektortyp',
  'registries.detail.kind.connector-binding': 'Konnektorbindung',
