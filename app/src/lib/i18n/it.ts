...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Registri del Core',
  'home.coreRegistriesDescription':
    'Ispeziona record esatti di agenti, strumenti e connettori dal Core.',
  'home.coreRegistriesBlockedTitle': 'Integrazione Core richiesta',
  'home.coreRegistriesBlockedMissingDescription':
    'Completa integrazione Core desktop prima di ispezionare i registri.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Ripara integrazione Core desktop prima di ispezionare i registri.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Ricollega il bridge Core locale prima di ispezionare i registri.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Riconnettiti a Internet prima di ispezionare i registri.',
  'registries.page.eyebrow': 'Viste registro',
  'registries.page.title': 'Registri del Core',
  'registries.page.description':
    'Ispezione in sola lettura di record esatti di agenti, strumenti e connettori supportati dal Core.',
  'registries.page.readOnly':
    'Questa schermata non scrive mai configurazione, segreti o stato runtime.',
  'registries.page.retry': 'Riprova',
  'registries.page.tablistAria': 'Registri del Core',
  'registries.tab.agents': 'Agenti',
  'registries.tab.tools': 'Strumenti',
  'registries.tab.connectors': 'Connettori',
  'registries.summaryState.idle': 'Inattivo',
  'registries.summaryState.loading': 'Caricamento',
  'registries.summaryState.fresh': 'Recente',
  'registries.summaryState.stale': 'Obsoleto',
  'registries.summaryState.partial': 'Parziale',
  'registries.summaryState.blocked': 'Bloccato',
  'registries.summaryState.observed': 'Osservato',
  'registries.blocker.configRequiredTitle': 'Integrazione Core richiesta',
  'registries.blocker.configMissingDescription':
    'Nessuna configurazione di integrazione Core trovata per ispezione registri.',
  'registries.blocker.configInvalidTitle': 'Integrazione Core non valida',
  'registries.blocker.configInvalidDescription':
    'Configurazione integrazione Core attuale non valida per ispezione registri.',
  'registries.blocker.authRequiredTitle': 'Autenticazione Core richiesta',
  'registries.blocker.authRequiredDescription':
    'Ispezione registro non autenticata con Core per questa sessione.',
  'registries.blocker.forbiddenTitle': 'Ispezione registro vietata',
  'registries.blocker.forbiddenDescription':
    'Core ha rifiutato questo attore per ispezione registri tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant non disponibile',
  'registries.blocker.tenantUnavailableDescription':
    'Core ha segnalato che questo tenant è temporaneamente indisponibile per ispezione registro.',
  'registries.blocker.tenantInvariantTitle': 'Violazione invariante tenant',
  'registries.blocker.tenantInvariantDescription':
    'Core ha segnalato una violazione invariante tenant per ispezione registro.',
  'registries.blocker.genericDescription':
    'Integrazione Core sta bloccando attualmente ispezione registro.',
  'registries.blocker.readOnly':
    'Questa schermata è di sola lettura e non può scrivere configurazione per te.',
  'registries.blocker.fixFlow':
    'Correggi connessione Core nel flusso integrazione esistente e riprova qui.',
  'registries.collections.agents.title': 'Agenti',
  'registries.collections.agents.description':
    'Record agente pubblicati. Nessun record viene selezionato automaticamente.',
  'registries.collections.agents.loadMore': 'Carica altri agenti',
  'registries.collections.toolDefinitions.title': 'Definizioni',
  'registries.collections.toolDefinitions.description':
    'Contratti strumento pubblicati, separati dalle abilitazioni permesso.',
  'registries.collections.toolDefinitions.loadMore': 'Carica altre definizioni',
  'registries.collections.toolEnablements.title': 'Abilitazioni',
  'registries.collections.toolEnablements.description':
    'Controlli permesso e limiti approvazione runtime per strumenti.',
  'registries.collections.connectorTypes.title': 'Tipi',
  'registries.collections.connectorTypes.description':
    'Tipi connettore pubblicati e contratti di normalizzazione.',
  'registries.collections.connectorTypes.loadMore': 'Carica altri tipi',
  'registries.collections.connectorBindings.title': 'Binding',
  'registries.collections.connectorBindings.description':
    'Account provider collegati e selezioni capacità.',
  'registries.collections.connectorBindings.loadMore': 'Carica altri binding',
  'registries.items.created': 'Creato {date}',
  'registries.items.fingerprint.config': 'Impronta configurazione {fingerprint}',
  'registries.items.fingerprint.definition': 'Definizione fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Tipo fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Impronta collegamento {fingerprint}',
  'registries.items.meta.noAuditMode': 'Nessuna modalità audit',
  'registries.items.meta.approvalRequired': 'Approvazione richiesta',
  'registries.items.meta.noApprovalGate': 'Nessun gate approvazione',
  'registries.items.status.noTenantEnablement': 'Nessuna abilitazione tenant restituita',
  'registries.live.blocked': 'Avviso: {title}. {description}',
  'registries.live.loaded': 'Scheda {tab} attiva. Selezionato {key} versione {version}.',
  'registries.live.loading': 'Scheda {tab} attiva. Caricamento {key} versione {version}.',
  'registries.live.idle': 'Scheda {tab} attiva. Nessun dettaglio selezionato.',
  'registries.drawer.title': 'Dettaglio registro',
  'registries.drawer.eyebrow': 'Dettaglio registro',
  'registries.collection.state.idle': 'Inattivo',
  'registries.collection.state.loading': 'Caricamento',
  'registries.collection.state.observed': 'Osservato',
  'registries.collection.state.stale': 'Obsoleto',
  'registries.collection.state.blocked': 'Bloccato',
  'registries.collection.body.idle': 'In attesa della prima osservazione.',
  'registries.collection.body.loading': 'Aggiornamento dei record esatti dal Core.',
  'registries.collection.body.empty': 'Osservato senza record restituiti.',
  'registries.collection.body.observedAt': 'Osservato alle {observedAt}.',
  'registries.collection.body.stale':
    'Osservato alle {observedAt}; ultimo aggiornamento ha mantenuto ultimi dati validi.',
  'registries.collection.body.blocked': 'Core ha rifiutato questa raccolta per ispezione.',
  'registries.collection.empty': 'Nessun record esatto disponibile ancora in questa raccolta.',
  'registries.detail.notAvailable': 'Non disponibile',
  'registries.detail.copyFingerprint': 'Copia fingerprint completo',
  'registries.detail.emptySchemaObject': 'Oggetto schema vuoto',
  'registries.detail.schemaType': 'Tipo {type}',
  'registries.detail.schemaProperties': '{count} proprietà',
  'registries.detail.schemaRequired': '{count} obbligatorie',
  'registries.detail.noFields': 'Nessun campo',
  'registries.detail.fieldsSampleMore': '{count} campi · {sample}…',
  'registries.detail.fieldsSample': '{count} campi · {sample}',
  'registries.detail.noNormalizationContracts': 'Nessun contratto normalizzazione',
  'registries.detail.unresolved': 'Non risolto: {label}',
  'registries.detail.deferred': 'Carica la scheda di destinazione per ispezionare {label}.',
  'registries.detail.fingerprint.configuration': 'Fingerprint configurazione',
  'registries.detail.fingerprint.definition': 'Fingerprint definizione',
  'registries.detail.fingerprint.connectorType': 'Fingerprint tipo connettore',
  'registries.detail.fingerprint.binding': 'Fingerprint binding',
  'registries.detail.section.agentLifecycle': 'Ciclo di vita agente',
  'registries.detail.section.exactToolReferences': 'Riferimenti strumento esatti',
  'registries.detail.section.logicalReferenceWarnings': 'Avvisi riferimenti logici',
  'registries.detail.section.configuration': 'Configurazione',
  'registries.detail.section.definitionLifecycle': 'Ciclo di vita definizione',
  'registries.detail.section.schemas': 'Schemi',
  'registries.detail.section.enablementLifecycle': 'Ciclo di vita abilitazione',
  'registries.detail.section.definitionLink': 'Collegamento definizione',
  'registries.detail.section.typeLifecycle': 'Ciclo di vita tipo',
  'registries.detail.section.contracts': 'Contratti',
  'registries.detail.section.bindingLifecycle': 'Ciclo di vita binding',
  'registries.detail.section.exactConnectorType': 'Tipo connettore esatto',
  'registries.detail.section.logicalReferences': 'Riferimenti logici',
  'registries.detail.note.activeRecords':
    'I record attivi sono stati di pubblicazione, non permessi runtime.',
  'registries.detail.noExactToolRefs': 'Nessun riferimento strumento esatto dichiarato.',
  'registries.detail.note.logicalReferenceWarnings':
    'I riferimenti logici richiedono follow-up fuori da questa vista di sola lettura.',
  'registries.detail.field.lifecycle': 'Ciclo di vita',
  'registries.detail.field.owner': 'Proprietario',
  'registries.detail.field.created': 'Creato',
  'registries.detail.field.knowledgeScopes': 'Ambiti conoscenza',
  'registries.detail.field.riskPolicy': 'Policy rischio',
  'registries.detail.none': 'Nessuno',
  'registries.detail.field.effectClass': 'Classe effetto',
  'registries.detail.field.schemaVersion': 'Versione schema',
  'registries.detail.field.enablement': 'Abilitazione',
  'registries.detail.field.inputSchema': 'Schema input',
  'registries.detail.field.outputSchema': 'Schema output',
  'registries.detail.field.timeoutDefaults': 'Timeout predefiniti',
  'registries.detail.field.retryContract': 'Contratto retry',
  'registries.detail.field.auditContract': 'Contratto audit',
  'registries.detail.viewRawJson': 'Visualizza JSON grezzo',
  'registries.detail.field.generation': 'Generazione',
  'registries.detail.field.approvalRequired': 'Approvazione richiesta',
  'registries.detail.field.auditMode': 'Modalità audit',
  'registries.detail.notSet': 'Non impostato',
  'registries.detail.field.timeoutCap': 'Limite timeout',
  'registries.detail.field.allowTtl': 'TTL consentito',
  'registries.detail.field.updated': 'Aggiornato',
  'registries.detail.note.enablementRecords':
    'I record di abilitazione esprimono controlli di permesso, non stato pubblicazione definizione.',
  'registries.detail.field.sourceType': 'Tipo sorgente',
  'registries.detail.field.capabilities': 'Capacità',
  'registries.detail.field.normalizationContracts': 'Contratti normalizzazione',
  'registries.detail.field.deliveryBehavior': 'Comportamento consegna',
  'registries.detail.field.providerAccountReference': 'Riferimento account provider',
  'registries.detail.note.logicalReferencesSecret':
    'Solo riferimento logico; segreto non mostrato.',
  'registries.detail.field.configReference': 'Riferimento configurazione',
  'registries.detail.field.credentialReference': 'Riferimento credenziale',
  'registries.detail.empty':
    'Seleziona un record per ispezionare la sua versione esatta del registro.',
  'registries.detail.state.loading': 'Caricamento dettaglio registro esatto...',
  'registries.detail.state.missing':
    'Core ha segnalato che questa versione esatta del record non esiste più.',
  'registries.detail.state.error':
    'Core non ha potuto caricare questo record esatto in questo momento.',
  'registries.detail.kind.agent': 'Agente',
  'registries.detail.kind.tool-definition': 'Definizione strumento',
  'registries.detail.kind.tool-enablement': 'Abilitazione strumento',
  'registries.detail.kind.connector-type': 'Tipo connettore',
  'registries.detail.kind.connector-binding': 'Binding connettore',
