...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Registros do Core',
  'home.coreRegistriesDescription':
    'Inspecione registros exatos de agentes, ferramentas e conectores do Core.',
  'home.coreRegistriesBlockedTitle': 'Integração com Core obrigatória',
  'home.coreRegistriesBlockedMissingDescription':
    'Conclua a integração do Core no desktop antes de inspecionar os registros.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Repare a integração do Core no desktop antes de inspecionar os registros.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Reconecte a ponte local do Core antes de inspecionar os registros.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Reconecte-se à internet antes de inspecionar os registros.',
  'registries.page.eyebrow': 'Visões do registro',
  'registries.page.title': 'Registros do Core',
  'registries.page.description':
    'Inspeção somente leitura de registros exatos de agentes, ferramentas e conectores apoiados pelo Core.',
  'registries.page.readOnly':
    'Esta tela nunca grava configuração, segredos nem estado de execução.',
  'registries.page.retry': 'Tentar novamente',
  'registries.page.tablistAria': 'Registros do Core',
  'registries.tab.agents': 'Agentes',
  'registries.tab.tools': 'Ferramentas',
  'registries.tab.connectors': 'Conectores',
  'registries.summaryState.idle': 'Inativo',
  'registries.summaryState.loading': 'Carregando',
  'registries.summaryState.fresh': 'Recente',
  'registries.summaryState.stale': 'Desatualizado',
  ...
  'registries.blocker.configRequiredTitle': 'Integração com Core obrigatória',
  'registries.blocker.configMissingDescription':
    'Nenhuma configuração de integração com Core foi encontrada para inspeção dos registros.',
  'registries.blocker.configInvalidTitle': 'Integração com Core inválida',
  'registries.blocker.configInvalidDescription':
    'A configuração atual de integração com Core é inválida para inspeção dos registros.',
  'registries.blocker.authRequiredTitle': 'Autenticação com Core obrigatória',
  'registries.blocker.authRequiredDescription':
    'A inspeção do registro não conseguiu autenticar com o Core nesta sessão.',
  'registries.blocker.forbiddenTitle': 'Inspeção do registro proibida',
  'registries.blocker.forbiddenDescription':
    'O Core rejeitou este ator para inspeção de registros do tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant indisponível',
  'registries.blocker.tenantUnavailableDescription':
    'O Core informou que este tenant está temporariamente indisponível para inspeção do registro.',
  'registries.blocker.tenantInvariantTitle': 'Violação de invariante do tenant',
  'registries.blocker.tenantInvariantDescription':
    'O Core informou uma violação de invariante do tenant para inspeção do registro.',
  'registries.blocker.genericDescription':
    'A integração com Core está bloqueando a inspeção do registro neste momento.',
  'registries.blocker.readOnly':
    'Esta tela é somente leitura e não pode gravar configuração por você.',
  'registries.blocker.fixFlow':
    'Corrija a conexão com o Core no fluxo de integração existente e tente novamente aqui.',
  'registries.collections.agents.title': 'Agentes',
  'registries.collections.agents.description':
    'Registros publicados de agentes. Nenhum registro é selecionado automaticamente.',
  'registries.collections.agents.loadMore': 'Carregar mais agentes',
  'registries.collections.toolDefinitions.title': 'Definições',
  'registries.collections.toolDefinitions.description':
    'Contratos de ferramentas publicados, separados das habilitações de permissão.',
  'registries.collections.toolDefinitions.loadMore': 'Carregar mais definições',
  'registries.collections.toolEnablements.title': 'Habilitações',
  'registries.collections.toolEnablements.description':
    'Portões de permissão e limites de aprovação em tempo de execução para ferramentas.',
  'registries.collections.connectorTypes.title': 'Tipos',
  'registries.collections.connectorTypes.description':
    'Tipos de conectores publicados e contratos de normalização.',
  'registries.collections.connectorTypes.loadMore': 'Carregar mais tipos',
  'registries.collections.connectorBindings.title': 'Vinculações',
  'registries.collections.connectorBindings.description':
    'Contas de provedor vinculadas e seleções de capacidades.',
  'registries.collections.connectorBindings.loadMore': 'Carregar mais vinculações',
  'registries.items.created': 'Criado {date}',
  'registries.items.fingerprint.config': 'Fingerprint de configuração {fingerprint}',
  'registries.items.fingerprint.definition': 'Definição fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Tipo fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Vinculação fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'Sem modo de auditoria',
  'registries.items.meta.approvalRequired': 'Aprovação obrigatória',
  'registries.items.meta.noApprovalGate': 'Sem portão de aprovação',
  'registries.items.status.noTenantEnablement': 'Nenhuma habilitação do tenant retornada',
  'registries.live.blocked': 'Aviso: {title}. {description}',
  'registries.live.loaded': 'Aba {tab} ativa. {key} versão {version} selecionado.',
  'registries.live.loading': 'Aba {tab} ativa. Carregando {key} versão {version}.',
  'registries.live.idle': 'Aba {tab} ativa. Nenhum detalhe selecionado.',
  'registries.drawer.title': 'Detalhe do registro',
  'registries.drawer.eyebrow': 'Detalhe do registro',
  'registries.collection.state.idle': 'Inativo',
  'registries.collection.state.loading': 'Carregando',
  'registries.collection.state.observed': 'Observado',
  'registries.collection.state.stale': 'Desatualizado',
  'registries.collection.state.blocked': 'Bloqueado',
  'registries.collection.body.idle': 'Aguardando a primeira observação.',
  'registries.collection.body.loading': 'Atualizando os registros exatos a partir do Core.',
  'registries.collection.body.empty': 'Observado sem registros retornados.',
  'registries.collection.body.observedAt': 'Observado em {observedAt}.',
  'registries.collection.body.stale':
    'Observado em {observedAt}; a última atualização manteve os últimos dados válidos.',
  'registries.collection.body.blocked': 'O Core rejeitou esta coleção para inspeção.',
  'registries.collection.empty': 'Ainda não há registros exatos disponíveis nesta coleção.',
  'registries.detail.notAvailable': 'Não disponível',
  'registries.detail.copyFingerprint': 'Copiar fingerprint completo',
  'registries.detail.emptySchemaObject': 'Objeto de esquema vazio',
  'registries.detail.schemaType': 'Tipo {type}',
  'registries.detail.schemaProperties': '{count} propriedades',
  'registries.detail.schemaRequired': '{count} obrigatórias',
  'registries.detail.noFields': 'Sem campos',
  'registries.detail.fieldsSampleMore': '{count} campos · {sample}…',
  'registries.detail.fieldsSample': '{count} campos · {sample}',
  'registries.detail.noNormalizationContracts': 'Sem contratos de normalização',
  'registries.detail.unresolved': 'Não resolvido: {label}',
  'registries.detail.deferred': 'Carregue a aba de destino para inspecionar {label}.',
  'registries.detail.fingerprint.configuration': 'Fingerprint de configuração',
  'registries.detail.fingerprint.definition': 'Fingerprint de definição',
  'registries.detail.fingerprint.connectorType': 'Fingerprint de tipo de conector',
  'registries.detail.fingerprint.binding': 'Fingerprint de vinculação',
  'registries.detail.section.agentLifecycle': 'Ciclo de vida do agente',
  'registries.detail.section.exactToolReferences': 'Referências exatas de ferramentas',
  'registries.detail.section.logicalReferenceWarnings': 'Avisos de referências lógicas',
  'registries.detail.section.configuration': 'Configuração',
  'registries.detail.section.definitionLifecycle': 'Ciclo de vida da definição',
  'registries.detail.section.schemas': 'Esquemas',
  'registries.detail.section.enablementLifecycle': 'Ciclo de vida da habilitação',
  'registries.detail.section.definitionLink': 'Link da definição',
  'registries.detail.section.typeLifecycle': 'Ciclo de vida do tipo',
  'registries.detail.section.contracts': 'Contratos',
  'registries.detail.section.bindingLifecycle': 'Ciclo de vida da vinculação',
  'registries.detail.section.exactConnectorType': 'Tipo exato de conector',
  'registries.detail.section.logicalReferences': 'Referências lógicas',
  'registries.detail.note.activeRecords':
    'Registros ativos são estados de publicação, não concessões de permissão em tempo de execução.',
  'registries.detail.noExactToolRefs': 'Nenhuma referência exata de ferramenta foi declarada.',
  'registries.detail.note.logicalReferenceWarnings':
    'Referências lógicas exigem acompanhamento fora desta visão somente leitura.',
  'registries.detail.field.lifecycle': 'Ciclo de vida',
  'registries.detail.field.owner': 'Proprietário',
  'registries.detail.field.created': 'Criado',
  'registries.detail.field.knowledgeScopes': 'Escopos de conhecimento',
  'registries.detail.field.riskPolicy': 'Política de risco',
  'registries.detail.none': 'Nenhum',
  'registries.detail.field.effectClass': 'Classe de efeito',
  'registries.detail.field.schemaVersion': 'Versão do esquema',
  'registries.detail.field.enablement': 'Habilitação',
  'registries.detail.field.inputSchema': 'Esquema de entrada',
  'registries.detail.field.outputSchema': 'Esquema de saída',
  'registries.detail.field.timeoutDefaults': 'Timeouts padrão',
  'registries.detail.field.retryContract': 'Contrato de retry',
  'registries.detail.field.auditContract': 'Contrato de auditoria',
  'registries.detail.viewRawJson': 'Ver JSON bruto',
  'registries.detail.field.generation': 'Geração',
  'registries.detail.field.approvalRequired': 'Aprovação obrigatória',
  'registries.detail.field.auditMode': 'Modo de auditoria',
  'registries.detail.notSet': 'Não definido',
  'registries.detail.field.timeoutCap': 'Limite de timeout',
  'registries.detail.field.allowTtl': 'TTL permitido',
  'registries.detail.field.updated': 'Atualizado',
  'registries.detail.note.enablementRecords':
    'Registros de habilitação expressam controles de permissão, não estado de publicação da definição.',
  'registries.detail.field.sourceType': 'Tipo de origem',
  'registries.detail.field.capabilities': 'Capacidades',
  'registries.detail.field.normalizationContracts': 'Contratos de normalização',
  'registries.detail.field.deliveryBehavior': 'Comportamento de entrega',
  'registries.detail.field.providerAccountReference': 'Referência de conta do provedor',
  'registries.detail.note.logicalReferencesSecret':
    'Apenas referência lógica; segredo não exibido.',
  'registries.detail.field.configReference': 'Referência de configuração',
  'registries.detail.field.credentialReference': 'Referência de credencial',
  'registries.detail.empty': 'Selecione um registro para inspecionar sua versão exata.',
  'registries.detail.state.loading': 'Carregando detalhe exato do registro...',
  'registries.detail.state.missing':
    'O Core informou que esta versão exata do registro não existe mais.',
  'registries.detail.state.error': 'O Core não conseguiu carregar este registro exato agora.',
  'registries.detail.kind.agent': 'Agente',
  'registries.detail.kind.tool-definition': 'Definição de ferramenta',
  'registries.detail.kind.tool-enablement': 'Habilitação de ferramenta',
  'registries.detail.kind.connector-type': 'Tipo de conector',
  'registries.detail.kind.connector-binding': 'Vinculação de conector',
