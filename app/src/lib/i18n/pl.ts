...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Rejestry Core',
  'home.coreRegistriesDescription':
    'Sprawdzaj dokładne rekordy agentów, narzędzi i konektorów z Core.',
  'home.coreRegistriesBlockedTitle': 'Integracja Core wymagana',
  'home.coreRegistriesBlockedMissingDescription':
    'Ukończ integrację Core na desktopie przed sprawdzeniem rejestrów.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Napraw integrację Core na desktopie przed sprawdzeniem rejestrów.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Połącz ponownie lokalny most Core przed sprawdzeniem rejestrów.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Połącz się ponownie z internetem przed sprawdzeniem rejestrów.',
  'registries.page.eyebrow': 'Widoki rejestru',
  'registries.page.title': 'Rejestry Core',
  'registries.page.description':
    'Podgląd tylko do odczytu dokładnych rekordów agentów, narzędzi i konektorów z Core.',
  'registries.page.readOnly':
    'Ten ekran nigdy nie zapisuje konfiguracji, sekretów ani stanu działania.',
  'registries.page.retry': 'Spróbuj ponownie',
  'registries.page.tablistAria': 'Rejestry Core',
  'registries.tab.agents': 'Agenci',
  'registries.tab.tools': 'Narzędzia',
  'registries.tab.connectors': 'Konektory',
  'registries.summaryState.idle': 'Bezczynny',
  'registries.summaryState.loading': 'Ładowanie',
  'registries.summaryState.fresh': 'Świeży',
  'registries.summaryState.stale': 'Nieaktualny',
  'registries.summaryState.partial': 'Częściowy',
  'registries.summaryState.blocked': 'Zablokowany',
  'registries.summaryState.observed': 'Zaobserwowany',
  'registries.blocker.configRequiredTitle': 'Integracja Core wymagana',
  'registries.blocker.configMissingDescription':
    'Nie znaleziono konfiguracji integracji Core do sprawdzania rejestrów.',
  'registries.blocker.configInvalidTitle': 'Integracja Core nieprawidłowa',
  'registries.blocker.configInvalidDescription':
    'Bieżąca konfiguracja integracji Core jest nieprawidłowa do sprawdzania rejestrów.',
  'registries.blocker.authRequiredTitle': 'Uwierzytelnienie Core wymagane',
  'registries.blocker.authRequiredDescription':
    'Sprawdzanie rejestru nie mogło uwierzytelnić się w Core dla tej sesji.',
  'registries.blocker.forbiddenTitle': 'Sprawdzanie rejestru zabronione',
  'registries.blocker.forbiddenDescription':
    'Core odrzucił tego aktora dla sprawdzania rejestrów tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant niedostępny',
  'registries.blocker.tenantUnavailableDescription':
    'Core zgłosił, że tenant jest tymczasowo niedostępny dla sprawdzania rejestru.',
  'registries.blocker.tenantInvariantTitle': 'Naruszenie niezmiennika tenant',
  'registries.blocker.tenantInvariantDescription':
    'Core zgłosił naruszenie niezmiennika tenant dla sprawdzania rejestru.',
  'registries.blocker.genericDescription': 'Integracja Core obecnie blokuje sprawdzanie rejestru.',
  'registries.blocker.readOnly':
    'Ten ekran jest tylko do odczytu i nie może zapisać konfiguracji za Ciebie.',
  'registries.blocker.fixFlow':
    'Napraw połączenie Core w istniejącym przepływie integracji i spróbuj ponownie tutaj.',
  'registries.collections.agents.title': 'Agenci',
  'registries.collections.agents.description':
    'Opublikowane rekordy agentów. Żaden rekord nie jest wybierany automatycznie.',
  'registries.collections.agents.loadMore': 'Załaduj więcej agentów',
  'registries.collections.toolDefinitions.title': 'Definicje',
  'registries.collections.toolDefinitions.description':
    'Opublikowane kontrakty narzędzi, oddzielone od włączeń uprawnień.',
  'registries.collections.toolDefinitions.loadMore': 'Załaduj więcej definicji',
  'registries.collections.toolEnablements.title': 'Włączenia',
  'registries.collections.toolEnablements.description':
    'Bramki uprawnień i limity zgód w czasie działania dla narzędzi.',
  'registries.collections.connectorTypes.title': 'Typy',
  'registries.collections.connectorTypes.description':
    'Opublikowane typy konektorów i kontrakty normalizacji.',
  'registries.collections.connectorTypes.loadMore': 'Załaduj więcej typów',
  'registries.collections.connectorBindings.title': 'Powiązania',
  'registries.collections.connectorBindings.description':
    'Powiązane konta dostawców i wybory możliwości.',
  'registries.collections.connectorBindings.loadMore': 'Załaduj więcej powiązań',
  'registries.items.created': 'Utworzono {date}',
  'registries.items.fingerprint.config': 'Fingerprint konfiguracji {fingerprint}',
  'registries.items.fingerprint.definition': 'Definicja fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Typ fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Powiązanie fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'Brak trybu audytu',
  'registries.items.meta.approvalRequired': 'Wymagana zgoda',
  'registries.items.meta.noApprovalGate': 'Brak bramki zgody',
  'registries.items.status.noTenantEnablement': 'Nie zwrócono włączenia tenant',
  'registries.live.blocked': 'Uwaga: {title}. {description}',
  'registries.live.loaded': 'Karta {tab} aktywna. Wybrano {key} w wersji {version}.',
  'registries.live.loading': 'Karta {tab} aktywna. Ładowanie {key} w wersji {version}.',
  'registries.live.idle': 'Karta {tab} aktywna. Nie wybrano szczegółu.',
  'registries.drawer.title': 'Szczegół rejestru',
  'registries.drawer.eyebrow': 'Szczegół rejestru',
  'registries.collection.state.idle': 'Bezczynny',
  'registries.collection.state.loading': 'Ładowanie',
  'registries.collection.state.observed': 'Zaobserwowany',
  'registries.collection.state.stale': 'Nieaktualny',
  'registries.collection.state.blocked': 'Zablokowany',
  'registries.collection.body.idle': 'Oczekiwanie na pierwszą obserwację.',
  'registries.collection.body.loading': 'Odświeżanie dokładnych rekordów z Core.',
  'registries.collection.body.empty': 'Zaobserwowano bez zwróconych rekordów.',
  'registries.collection.body.observedAt': 'Zaobserwowano o {observedAt}.',
  'registries.collection.body.stale':
    'Zaobserwowano o {observedAt}; ostatnie odświeżenie zachowało ostatnie poprawne dane.',
  'registries.collection.body.blocked': 'Core odrzucił tę kolekcję dla sprawdzania.',
  'registries.collection.empty': 'Brak dokładnych rekordów dostępnych jeszcze w tej kolekcji.',
  'registries.detail.notAvailable': 'Niedostępne',
  'registries.detail.copyFingerprint': 'Kopiuj pełny fingerprint',
  'registries.detail.emptySchemaObject': 'Pusty obiekt schematu',
  'registries.detail.schemaType': 'Typ {type}',
  'registries.detail.schemaProperties': '{count} właściwości',
  'registries.detail.schemaRequired': '{count} wymagane',
  'registries.detail.noFields': 'Brak pól',
  'registries.detail.fieldsSampleMore': '{count} pól · {sample}…',
  'registries.detail.fieldsSample': '{count} pól · {sample}',
  'registries.detail.noNormalizationContracts': 'Brak kontraktów normalizacji',
  'registries.detail.unresolved': 'Nierozwiązane: {label}',
  'registries.detail.deferred': 'Załaduj kartę docelową, aby sprawdzić {label}.',
  'registries.detail.fingerprint.configuration': 'Fingerprint konfiguracji',
  'registries.detail.fingerprint.definition': 'Fingerprint definicji',
  'registries.detail.fingerprint.connectorType': 'Fingerprint typu konektora',
  'registries.detail.fingerprint.binding': 'Fingerprint powiązania',
  'registries.detail.section.agentLifecycle': 'Cykl życia agenta',
  'registries.detail.section.exactToolReferences': 'Dokładne referencje narzędzi',
  'registries.detail.section.logicalReferenceWarnings': 'Ostrzeżenia logicznych referencji',
  'registries.detail.section.configuration': 'Konfiguracja',
  'registries.detail.section.definitionLifecycle': 'Cykl życia definicji',
  'registries.detail.section.schemas': 'Schematy',
  'registries.detail.section.enablementLifecycle': 'Cykl życia włączenia',
  'registries.detail.section.definitionLink': 'Link definicji',
  'registries.detail.section.typeLifecycle': 'Cykl życia typu',
  'registries.detail.section.contracts': 'Kontrakty',
  'registries.detail.section.bindingLifecycle': 'Cykl życia powiązania',
  'registries.detail.section.exactConnectorType': 'Dokładny typ konektora',
  'registries.detail.section.logicalReferences': 'Logiczne referencje',
  'registries.detail.note.activeRecords':
    'Aktywne rekordy są stanami publikacji, a nie uprawnieniami czasu działania.',
  'registries.detail.noExactToolRefs': 'Nie zadeklarowano dokładnych referencji narzędzi.',
  'registries.detail.note.logicalReferenceWarnings':
    'Logiczne referencje wymagają dalszych działań poza tym widokiem tylko do odczytu.',
  'registries.detail.field.lifecycle': 'Cykl życia',
  'registries.detail.field.owner': 'Właściciel',
  'registries.detail.field.created': 'Utworzono',
  'registries.detail.field.knowledgeScopes': 'Zakresy wiedzy',
  'registries.detail.field.riskPolicy': 'Polityka ryzyka',
  'registries.detail.none': 'Brak',
  'registries.detail.field.effectClass': 'Klasa efektu',
  'registries.detail.field.schemaVersion': 'Wersja schematu',
  'registries.detail.field.enablement': 'Włączenie',
  'registries.detail.field.inputSchema': 'Schemat wejścia',
  'registries.detail.field.outputSchema': 'Schemat wyjścia',
  'registries.detail.field.timeoutDefaults': 'Domyślne timeouty',
  'registries.detail.field.retryContract': 'Kontrakt retry',
  'registries.detail.field.auditContract': 'Kontrakt audytu',
  'registries.detail.viewRawJson': 'Pokaż surowy JSON',
  'registries.detail.field.generation': 'Generacja',
  'registries.detail.field.approvalRequired': 'Wymagana zgoda',
  'registries.detail.field.auditMode': 'Tryb audytu',
  'registries.detail.notSet': 'Nie ustawiono',
  'registries.detail.field.timeoutCap': 'Limit timeoutu',
  'registries.detail.field.allowTtl': 'Dozwolony TTL',
  'registries.detail.field.updated': 'Zaktualizowano',
  'registries.detail.note.enablementRecords':
    'Rekordy włączeń opisują bramki uprawnień, a nie stan publikacji definicji.',
  'registries.detail.field.sourceType': 'Typ źródła',
  'registries.detail.field.capabilities': 'Możliwości',
  'registries.detail.field.normalizationContracts': 'Kontrakty normalizacji',
  'registries.detail.field.deliveryBehavior': 'Zachowanie dostawy',
  'registries.detail.field.providerAccountReference': 'Referencja konta dostawcy',
  'registries.detail.note.logicalReferencesSecret':
    'Tylko logiczna referencja; sekret nie jest wyświetlany.',
  'registries.detail.field.configReference': 'Referencja konfiguracji',
  'registries.detail.field.credentialReference': 'Referencja poświadczenia',
  'registries.detail.empty': 'Wybierz rekord, aby sprawdzić jego dokładną wersję rejestru.',
  'registries.detail.state.loading': 'Ładowanie dokładnego szczegółu rejestru...',
  ...
  'registries.detail.kind.connector-binding': 'Powiązanie konektora',
