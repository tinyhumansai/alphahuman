...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Core রেজিস্ট্রি',
  'home.coreRegistriesDescription':
    'Core থেকে নির্দিষ্ট Agent, Tool এবং Connector রেকর্ড পরিদর্শন করুন।',
  'home.coreRegistriesBlockedTitle': 'Core ইন্টিগ্রেশন প্রয়োজন',
  'home.coreRegistriesBlockedMissingDescription':
    'রেজিস্ট্রি দেখার আগে ডেস্কটপ Core ইন্টিগ্রেশন সম্পূর্ণ করুন।',
  'home.coreRegistriesBlockedInvalidDescription':
    'রেজিস্ট্রি দেখার আগে ডেস্কটপ Core ইন্টিগ্রেশন মেরামত করুন।',
  'home.coreRegistriesBlockedBridgeDescription':
    'রেজিস্ট্রি দেখার আগে স্থানীয় Core ব্রিজ পুনরায় সংযোগ করুন।',
  'home.coreRegistriesBlockedOfflineDescription':
    'রেজিস্ট্রি দেখার আগে আবার ইন্টারনেটে সংযুক্ত হন।',
  'registries.page.eyebrow': 'রেজিস্ট্রি ভিউ',
  'registries.page.title': 'Core রেজিস্ট্রি',
  'registries.page.description':
    'Core-সমর্থিত নির্দিষ্ট Agent, Tool এবং Connector রেকর্ডের শুধু-পাঠযোগ্য পরিদর্শন।',
  'registries.page.readOnly': 'এই স্ক্রিন কখনও কনফিগারেশন, গোপন তথ্য বা রানটাইম অবস্থা লেখে না।',
  'registries.page.retry': 'আবার চেষ্টা করুন',
  'registries.page.tablistAria': 'Core রেজিস্ট্রি',
  'registries.tab.agents': 'এজেন্ট',
  'registries.tab.tools': 'টুল',
  'registries.tab.connectors': 'কনেক্টর',
  'registries.summaryState.idle': 'নিষ্ক্রিয়',
  'registries.summaryState.loading': 'লোড হচ্ছে',
  'registries.summaryState.fresh': 'সাম্প্রতিক',
  'registries.summaryState.stale': 'পুরোনো',
  'registries.summaryState.partial': 'আংশিক',
  'registries.summaryState.blocked': 'অবরুদ্ধ',
  'registries.summaryState.observed': 'পর্যবেক্ষিত',
  'registries.blocker.configRequiredTitle': 'Core ইন্টিগ্রেশন প্রয়োজন',
  'registries.blocker.configMissingDescription':
    'রেজিস্ট্রি পরিদর্শনের জন্য Core ইন্টিগ্রেশন কনফিগারেশন পাওয়া যায়নি।',
  'registries.blocker.configInvalidTitle': 'Core ইন্টিগ্রেশন অবৈধ',
  'registries.blocker.configInvalidDescription':
    'বর্তমান Core ইন্টিগ্রেশন কনফিগারেশন রেজিস্ট্রি পরিদর্শনের জন্য বৈধ নয়।',
  'registries.blocker.authRequiredTitle': 'Core প্রমাণীকরণ প্রয়োজন',
  'registries.blocker.authRequiredDescription':
    'এই সেশনে রেজিস্ট্রি পরিদর্শন Core-এর সাথে প্রমাণীকরণ করতে পারেনি।',
  'registries.blocker.forbiddenTitle': 'রেজিস্ট্রি পরিদর্শন নিষিদ্ধ',
  'registries.blocker.forbiddenDescription':
    'Tenant রেজিস্ট্রি পরিদর্শনের জন্য Core এই actor-কে প্রত্যাখ্যান করেছে।',
  'registries.blocker.tenantUnavailableTitle': 'Tenant অনুপলব্ধ',
  'registries.blocker.tenantUnavailableDescription':
    'Core জানিয়েছে যে এই tenant সাময়িকভাবে রেজিস্ট্রি পরিদর্শনের জন্য উপলব্ধ নয়।',
  'registries.blocker.tenantInvariantTitle': 'Tenant invariant লঙ্ঘন',
  'registries.blocker.tenantInvariantDescription':
    'Core রেজিস্ট্রি পরিদর্শনের জন্য tenant invariant লঙ্ঘনের কথা জানিয়েছে।',
  'registries.blocker.genericDescription':
    'Core ইন্টিগ্রেশন বর্তমানে রেজিস্ট্রি পরিদর্শনকে বাধা দিচ্ছে।',
  'registries.blocker.readOnly':
    'এই স্ক্রিন শুধু-পাঠযোগ্য এবং আপনার জন্য কনফিগারেশন লিখতে পারে না।',
  'registries.blocker.fixFlow':
    'বিদ্যমান ইন্টিগ্রেশন ফ্লোতে Core সংযোগ ঠিক করুন, তারপর এখানে আবার চেষ্টা করুন।',
  'registries.collections.agents.title': 'এজেন্ট',
  'registries.collections.agents.description':
    'প্রকাশিত এজেন্ট রেকর্ড। কোনো রেকর্ড স্বয়ংক্রিয়ভাবে নির্বাচন করা হয় না।',
  'registries.collections.agents.loadMore': 'আরও এজেন্ট লোড করুন',
  'registries.collections.toolDefinitions.title': 'সংজ্ঞা',
  'registries.collections.toolDefinitions.description':
    'প্রকাশিত টুল চুক্তি, অনুমতি সক্রিয়করণ থেকে আলাদা।',
  'registries.collections.toolDefinitions.loadMore': 'আরও সংজ্ঞা লোড করুন',
  'registries.collections.toolEnablements.title': 'সক্রিয়করণ',
  'registries.collections.toolEnablements.description':
    'টুলের জন্য অনুমতি গেট এবং রানটাইম অনুমোদন সীমা।',
  'registries.collections.connectorTypes.title': 'ধরন',
  'registries.collections.connectorTypes.description':
    'প্রকাশিত কনেক্টর ধরন এবং নর্মালাইজেশন চুক্তি।',
  'registries.collections.connectorTypes.loadMore': 'আরও ধরন লোড করুন',
  'registries.collections.connectorBindings.title': 'বাইন্ডিং',
  'registries.collections.connectorBindings.description':
    'বাঁধা provider account এবং capability নির্বাচন।',
  'registries.collections.connectorBindings.loadMore': 'আরও বাইন্ডিং লোড করুন',
  'registries.items.created': 'তৈরি হয়েছে {date}',
  'registries.items.fingerprint.config': 'بিন্যাস ফিঙ্গারপ্রিন্ট {fingerprint}',
  'registries.items.fingerprint.definition': 'সংজ্ঞা fp:{fingerprint}',
  'registries.items.fingerprint.type': 'ধরন fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'বাইন্ডিং fp:{fingerprint}',
  'registries.items.meta.noAuditMode': 'কোনো audit mode নেই',
  'registries.items.meta.approvalRequired': 'অনুমোদন প্রয়োজন',
  'registries.items.meta.noApprovalGate': 'কোনো approval gate নেই',
  'registries.items.status.noTenantEnablement': 'কোনো tenant enablement ফেরত আসেনি',
  'registries.live.blocked': 'সতর্কতা: {title}. {description}',
  'registries.live.loaded': '{tab} ট্যাব সক্রিয়। {key} সংস্করণ {version} নির্বাচিত।',
  'registries.live.loading': '{tab} ট্যাব সক্রিয়। {key} সংস্করণ {version} লোড হচ্ছে।',
  'registries.live.idle': '{tab} ট্যাব সক্রিয়। কোনো বিস্তারিত নির্বাচন করা হয়নি।',
  'registries.drawer.title': 'রেজিস্ট্রি বিস্তারিত',
  'registries.drawer.eyebrow': 'রেজিস্ট্রি বিস্তারিত',
  'registries.collection.state.idle': 'নিষ্ক্রিয়',
  'registries.collection.state.loading': 'লোড হচ্ছে',
  'registries.collection.state.observed': 'পর্যবেক্ষিত',
  'registries.collection.state.stale': 'পুরোনো',
  'registries.collection.state.blocked': 'অবরুদ্ধ',
  'registries.collection.body.idle': 'প্রথম পর্যবেক্ষণের অপেক্ষায়।',
  'registries.collection.body.loading': 'Core থেকে নির্দিষ্ট রেকর্ড রিফ্রেশ করা হচ্ছে।',
  'registries.collection.body.empty': 'পর্যবেক্ষণ সম্পন্ন, কিন্তু কোনো রেকর্ড ফেরত আসেনি।',
  'registries.collection.body.observedAt': '{observedAt}-এ পর্যবেক্ষণ করা হয়েছে।',
  'registries.collection.body.stale':
    '{observedAt}-এ পর্যবেক্ষিত; সর্বশেষ রিফ্রেশ শেষ ভালো ডেটা ধরে রেখেছে।',
  'registries.collection.body.blocked': 'Core এই collection-কে পরিদর্শনের জন্য প্রত্যাখ্যান করেছে।',
  'registries.collection.empty': 'এই collection-এ এখনও কোনো নির্দিষ্ট রেকর্ড উপলব্ধ নেই।',
  'registries.detail.notAvailable': 'উপলব্ধ নয়',
  'registries.detail.copyFingerprint': 'সম্পূর্ণ fingerprint কপি করুন',
  'registries.detail.emptySchemaObject': 'খালি schema object',
  'registries.detail.schemaType': 'ধরন {type}',
  'registries.detail.schemaProperties': '{count}টি বৈশিষ্ট্য',
  'registries.detail.schemaRequired': '{count}টি প্রয়োজনীয়',
  'registries.detail.noFields': 'কোনো field নেই',
  'registries.detail.fieldsSampleMore': '{count}টি ক্ষেত্র · {sample}…',
  'registries.detail.fieldsSample': '{count}টি ক্ষেত্র · {sample}',
  'registries.detail.noNormalizationContracts': 'কোনো normalization contract নেই',
  'registries.detail.unresolved': 'অমীমাংসিত: {label}',
  'registries.detail.deferred': '{label} দেখতে target tab লোড করুন।',
  'registries.detail.fingerprint.configuration': 'কনফিগারেশন fingerprint',
  'registries.detail.fingerprint.definition': 'সংজ্ঞার fingerprint',
  'registries.detail.fingerprint.connectorType': 'কনেক্টর ধরন fingerprint',
  'registries.detail.fingerprint.binding': 'বাইন্ডিং fingerprint',
  'registries.detail.section.agentLifecycle': 'এজেন্ট lifecycle',
  'registries.detail.section.exactToolReferences': 'নির্দিষ্ট tool reference',
  'registries.detail.section.logicalReferenceWarnings': 'লজিক্যাল reference সতর্কতা',
  'registries.detail.section.configuration': 'কনফিগারেশন',
  'registries.detail.section.definitionLifecycle': 'সংজ্ঞার lifecycle',
  'registries.detail.section.schemas': 'Schema',
  'registries.detail.section.enablementLifecycle': 'সক্রিয়করণের lifecycle',
  'registries.detail.section.definitionLink': 'সংজ্ঞার লিংক',
  'registries.detail.section.typeLifecycle': 'ধরনের lifecycle',
  'registries.detail.section.contracts': 'চুক্তি',
  'registries.detail.section.bindingLifecycle': 'বাইন্ডিং lifecycle',
  'registries.detail.section.exactConnectorType': 'নির্দিষ্ট connector ধরন',
  'registries.detail.section.logicalReferences': 'লজিক্যাল reference',
  'registries.detail.note.activeRecords':
    'সক্রিয় রেকর্ড প্রকাশনার অবস্থা নির্দেশ করে, রানটাইম অনুমতি নয়।',
  'registries.detail.noExactToolRefs': 'কোনো নির্দিষ্ট tool reference ঘোষণা করা হয়নি।',
  'registries.detail.note.logicalReferenceWarnings':
    'এই শুধু-পাঠযোগ্য ভিউয়ের বাইরে লজিক্যাল reference অনুসরণ করতে হবে।',
  'registries.detail.field.lifecycle': 'জীবনচক্র',
  'registries.detail.field.owner': 'মালিক',
  'registries.detail.field.created': 'তৈরি হয়েছে',
  'registries.detail.field.knowledgeScopes': 'জ্ঞান ক্ষেত্র',
  'registries.detail.field.riskPolicy': 'ঝুঁকি নীতি',
  'registries.detail.none': 'কিছুই নয়',
  'registries.detail.field.effectClass': 'প্রভাব শ্রেণি',
  'registries.detail.field.schemaVersion': 'স্কিমা সংস্করণ',
  'registries.detail.field.enablement': 'সক্রিয়করণ',
  'registries.detail.field.inputSchema': 'ইনপুট স্কিমা',
  'registries.detail.field.outputSchema': 'আউটপুট স্কিমা',
  'registries.detail.field.timeoutDefaults': 'ডিফল্ট timeout',
  'registries.detail.field.retryContract': 'পুনরায় প্রচেষ্টা চুক্তি',
  'registries.detail.field.auditContract': 'অডিট চুক্তি',
  'registries.detail.viewRawJson': 'কাঁচা JSON দেখুন',
  'registries.detail.field.generation': 'প্রজন্ম',
  'registries.detail.field.approvalRequired': 'অনুমোদন প্রয়োজন',
  'registries.detail.field.auditMode': 'অডিট মোড',
  'registries.detail.notSet': 'সেট করা নেই',
  'registries.detail.field.timeoutCap': 'টাইমআউট সীমা',
  'registries.detail.field.allowTtl': 'অনুমোদিত TTL',
  'registries.detail.field.updated': 'আপডেট হয়েছে',
  'registries.detail.note.enablementRecords':
    'Enablement record অনুমতি গেট বোঝায়, সংজ্ঞার প্রকাশনা অবস্থা নয়।',
  'registries.detail.field.sourceType': 'উৎসের ধরন',
  'registries.detail.field.capabilities': 'Capability',
  'registries.detail.field.normalizationContracts': 'নর্মালাইজেশন চুক্তি',
  'registries.detail.field.deliveryBehavior': 'ডেলিভারি আচরণ',
  'registries.detail.field.providerAccountReference': 'প্রোভাইডার অ্যাকাউন্ট রেফারেন্স',
  'registries.detail.note.logicalReferencesSecret':
    'শুধু লজিক্যাল reference দেখানো হয়; গোপন তথ্য দেখানো হয় না।',
  'registries.detail.field.configReference': 'কনফিগারেশন রেফারেন্স',
  'registries.detail.field.credentialReference': 'ক্রেডেনশিয়াল রেফারেন্স',
  'registries.detail.empty': 'সঠিক রেজিস্ট্রি সংস্করণ দেখতে একটি রেকর্ড নির্বাচন করুন।',
  'registries.detail.state.loading': 'নির্দিষ্ট রেজিস্ট্রি বিস্তারিত লোড হচ্ছে...',
  'registries.detail.state.missing': 'Core জানিয়েছে যে এই নির্দিষ্ট রেকর্ড সংস্করণটি আর নেই।',
  'registries.detail.state.error': 'Core এখন এই নির্দিষ্ট রেকর্ডটি লোড করতে পারেনি।',
  'registries.detail.kind.agent': 'এজেন্ট',
  'registries.detail.kind.tool-definition': 'টুল সংজ্ঞা',
  'registries.detail.kind.tool-enablement': 'টুল সক্রিয়করণ',
  'registries.detail.kind.connector-type': 'কনেক্টর ধরন',
  'registries.detail.kind.connector-binding': 'কনেক্টর বাইন্ডিং',
