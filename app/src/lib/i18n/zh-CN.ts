...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Core 注册表',
  'home.coreRegistriesDescription': '检查来自 Core 的精确代理、工具和连接器记录。',
  'home.coreRegistriesBlockedTitle': '需要 Core 集成',
  'home.coreRegistriesBlockedMissingDescription': '请先完成桌面端 Core 集成，再检查注册表。',
  'home.coreRegistriesBlockedInvalidDescription': '请先修复桌面端 Core 集成，再检查注册表。',
  'home.coreRegistriesBlockedBridgeDescription': '请先重新连接本地 Core 桥接，再检查注册表。',
  'home.coreRegistriesBlockedOfflineDescription': '请先重新连接互联网，再检查注册表。',
  'registries.page.eyebrow': '注册表视图',
  'registries.page.title': 'Core 注册表',
  'registries.page.description': '对来自 Core 的精确代理、工具和连接器记录进行只读检查。',
  'registries.page.readOnly': '此页面绝不会写入配置、密钥或运行时状态。',
  'registries.page.retry': '重试',
  'registries.page.tablistAria': 'Core 注册表',
  'registries.tab.agents': '代理',
  'registries.tab.tools': '工具',
  'registries.tab.connectors': '连接器',
  'registries.summaryState.idle': '空闲',
  'registries.summaryState.loading': '加载中',
  'registries.summaryState.fresh': '最新',
  'registries.summaryState.stale': '陈旧',
  'registries.summaryState.partial': '部分',
  'registries.summaryState.blocked': '已阻止',
  'registries.summaryState.observed': '已观测',
  'registries.blocker.configRequiredTitle': '需要 Core 集成',
  'registries.blocker.configMissingDescription': '未找到用于检查注册表的 Core 集成配置。',
  'registries.blocker.configInvalidTitle': 'Core 集成无效',
  'registries.blocker.configInvalidDescription': '当前 Core 集成配置无法用于检查注册表。',
  'registries.blocker.authRequiredTitle': '需要 Core 身份验证',
  'registries.blocker.authRequiredDescription': '本次会话中的注册表检查无法通过 Core 身份验证。',
  'registries.blocker.forbiddenTitle': '注册表检查被拒绝',
  'registries.blocker.forbiddenDescription': 'Core 拒绝该参与者执行租户注册表检查。',
  'registries.blocker.tenantUnavailableTitle': '租户不可用',
  'registries.blocker.tenantUnavailableDescription': 'Core 报告此租户暂时无法执行注册表检查。',
  'registries.blocker.tenantInvariantTitle': '租户不变量冲突',
  'registries.blocker.tenantInvariantDescription': 'Core 报告注册表检查存在租户不变量冲突。',
  'registries.blocker.genericDescription': '当前是 Core 集成阻止了注册表检查。',
  'registries.blocker.readOnly': '此页面为只读页面，无法替你写入配置。',
  'registries.blocker.fixFlow': '请先在现有集成流程中修复 Core 连接，然后再回到这里重试。',
  'registries.collections.agents.title': '代理',
  'registries.collections.agents.description': '已发布的代理记录。不会自动选中任何记录。',
  'registries.collections.agents.loadMore': '加载更多代理',
  'registries.collections.toolDefinitions.title': '定义',
  'registries.collections.toolDefinitions.description':
    '已发布的工具契约，与权限启用记录分开显示。',
  'registries.collections.toolDefinitions.loadMore': '加载更多定义',
  'registries.collections.toolEnablements.title': '启用',
  'registries.collections.toolEnablements.description': '工具的权限闸门和运行时审批限制。',
  'registries.collections.connectorTypes.title': '类型',
  'registries.collections.connectorTypes.description': '已发布的连接器类型和规范化契约。',
  'registries.collections.connectorTypes.loadMore': '加载更多类型',
  'registries.collections.connectorBindings.title': '绑定',
  'registries.collections.connectorBindings.description': '已绑定的提供方账户和能力选择。',
  'registries.collections.connectorBindings.loadMore': '加载更多绑定',
  'registries.items.created': '创建于 {date}',
  'registries.items.fingerprint.config': '配置指纹 {fingerprint}',
  'registries.items.fingerprint.definition': '定义 fp:{fingerprint}',
  'registries.items.fingerprint.type': '类型 fp:{fingerprint}',
  'registries.items.fingerprint.binding': '绑定 fp:{fingerprint}',
  'registries.items.meta.noAuditMode': '无审计模式',
  'registries.items.meta.approvalRequired': '需要审批',
  'registries.items.meta.noApprovalGate': '无审批闸门',
  'registries.items.status.noTenantEnablement': '未返回租户启用记录',
  'registries.live.blocked': '提示：{title}。{description}',
  'registries.live.loaded': '{tab} 标签已激活。已选中 {key} 版本 {version}。',
  'registries.live.loading': '{tab} 标签已激活。正在加载 {key} 版本 {version}。',
  'registries.live.idle': '{tab} 标签已激活。尚未选择详情。',
  'registries.drawer.title': '注册表详情',
  'registries.drawer.eyebrow': '注册表详情',
  'registries.collection.state.idle': '空闲',
  'registries.collection.state.loading': '加载中',
  'registries.collection.state.observed': '已观测',
  'registries.collection.state.stale': '陈旧',
  'registries.collection.state.blocked': '已阻止',
  'registries.collection.body.idle': '正在等待第一次观测。',
  'registries.collection.body.loading': '正在从 Core 刷新精确记录。',
  'registries.collection.body.empty': '已完成观测，但没有返回任何记录。',
  'registries.collection.body.observedAt': '观测时间：{observedAt}。',
  'registries.collection.body.stale':
    '观测时间：{observedAt}；最近一次刷新保留了最后一份有效数据。',
  'registries.collection.body.blocked': 'Core 拒绝了对此集合的检查。',
  'registries.collection.empty': '此集合中暂时还没有可用的精确记录。',
  'registries.detail.notAvailable': '不可用',
  'registries.detail.copyFingerprint': '复制完整指纹',
  'registries.detail.emptySchemaObject': '空模式对象',
  'registries.detail.schemaType': '类型 {type}',
  'registries.detail.schemaProperties': '{count} 个属性',
  'registries.detail.schemaRequired': '{count} 个必填项',
  'registries.detail.noFields': '无字段',
  'registries.detail.fieldsSampleMore': '{count} 个字段 · {sample}…',
  'registries.detail.fieldsSample': '{count} 个字段 · {sample}',
  'registries.detail.noNormalizationContracts': '无规范化契约',
  'registries.detail.unresolved': '未解析：{label}',
  'registries.detail.deferred': '请先加载目标标签页，再检查 {label}。',
  'registries.detail.fingerprint.configuration': '配置指纹',
  'registries.detail.fingerprint.definition': '定义指纹',
  'registries.detail.fingerprint.connectorType': '连接器类型指纹',
  'registries.detail.fingerprint.binding': '绑定指纹',
  'registries.detail.section.agentLifecycle': '代理生命周期',
  'registries.detail.section.exactToolReferences': '精确工具引用',
  'registries.detail.section.logicalReferenceWarnings': '逻辑引用警告',
  'registries.detail.section.configuration': '配置',
  'registries.detail.section.definitionLifecycle': '定义生命周期',
  'registries.detail.section.schemas': '模式',
  'registries.detail.section.enablementLifecycle': '启用生命周期',
  'registries.detail.section.definitionLink': '定义链接',
  'registries.detail.section.typeLifecycle': '类型生命周期',
  'registries.detail.section.contracts': '契约',
  'registries.detail.section.bindingLifecycle': '绑定生命周期',
  'registries.detail.section.exactConnectorType': '精确连接器类型',
  'registries.detail.section.logicalReferences': '逻辑引用',
  'registries.detail.note.activeRecords': '活动记录表示发布状态，而不是运行时权限。',
  'registries.detail.noExactToolRefs': '未声明任何精确工具引用。',
  'registries.detail.note.logicalReferenceWarnings': '逻辑引用需要在此只读视图之外继续跟进。',
  'registries.detail.field.lifecycle': '生命周期',
  'registries.detail.field.owner': '所有者',
  'registries.detail.field.created': '创建时间',
  'registries.detail.field.knowledgeScopes': '知识范围',
  'registries.detail.field.riskPolicy': '风险策略',
  'registries.detail.none': '无',
  'registries.detail.field.effectClass': '效果类别',
  'registries.detail.field.schemaVersion': '模式版本',
  'registries.detail.field.enablement': '启用',
  'registries.detail.field.inputSchema': '输入模式',
  'registries.detail.field.outputSchema': '输出模式',
  'registries.detail.field.timeoutDefaults': '默认超时',
  'registries.detail.field.retryContract': '重试契约',
  'registries.detail.field.auditContract': '审计契约',
  'registries.detail.viewRawJson': '查看原始 JSON',
  'registries.detail.field.generation': '代次',
  'registries.detail.field.approvalRequired': '需要审批',
  'registries.detail.field.auditMode': '审计模式',
  'registries.detail.notSet': '未设置',
  'registries.detail.field.timeoutCap': '超时上限',
  'registries.detail.field.allowTtl': '允许 TTL',
  'registries.detail.field.updated': '更新时间',
  'registries.detail.note.enablementRecords': '启用记录表达的是权限闸门，而不是定义的发布状态。',
  'registries.detail.field.sourceType': '来源类型',
  'registries.detail.field.capabilities': '能力',
  'registries.detail.field.normalizationContracts': '规范化契约',
  'registries.detail.field.deliveryBehavior': '交付行为',
  'registries.detail.field.providerAccountReference': '提供方账户引用',
  'registries.detail.note.logicalReferencesSecret': '这里只显示逻辑引用，不显示密钥。',
  'registries.detail.field.configReference': '配置引用',
  'registries.detail.field.credentialReference': '凭证引用',
  'registries.detail.empty': '选择一条记录以检查其精确注册表版本。',
  'registries.detail.state.loading': '正在加载精确注册表详情...',
  'registries.detail.state.missing': 'Core 报告此精确记录版本已不存在。',
  'registries.detail.state.error': 'Core 当前无法加载此精确记录。',
  'registries.detail.kind.agent': '代理',
  'registries.detail.kind.tool-definition': '工具定义',
  'registries.detail.kind.tool-enablement': '工具启用',
  'registries.detail.kind.connector-type': '连接器类型',
  'registries.detail.kind.connector-binding': '连接器绑定',
