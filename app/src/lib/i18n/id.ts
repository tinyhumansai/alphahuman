...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Registri Core',
  'home.coreRegistriesDescription':
    'Periksa catatan Agent, Tool, dan Connector yang tepat dari Core.',
  'home.coreRegistriesBlockedTitle': 'Integrasi Core diperlukan',
  'home.coreRegistriesBlockedMissingDescription':
    'Selesaikan integrasi Core desktop sebelum memeriksa registri.',
  'home.coreRegistriesBlockedInvalidDescription':
    'Perbaiki integrasi Core desktop sebelum memeriksa registri.',
  'home.coreRegistriesBlockedBridgeDescription':
    'Sambungkan kembali bridge Core lokal sebelum memeriksa registri.',
  'home.coreRegistriesBlockedOfflineDescription':
    'Sambungkan kembali ke internet sebelum memeriksa registri.',
  'registries.page.eyebrow': 'Tampilan registri',
  'registries.page.title': 'Registri Core',
  'registries.page.description':
    'Pemeriksaan hanya-baca untuk catatan Agent, Tool, dan Connector yang tepat dari Core.',
  'registries.page.readOnly':
    'Layar ini tidak pernah menulis konfigurasi, rahasia, atau status runtime.',
  'registries.page.retry': 'Coba lagi',
  'registries.page.tablistAria': 'Registri Core',
  'registries.tab.agents': 'Agent',
  'registries.tab.tools': 'Tool',
  'registries.tab.connectors': 'Connector',
  'registries.summaryState.idle': 'Diam',
  'registries.summaryState.loading': 'Memuat',
  'registries.summaryState.fresh': 'Baru',
  'registries.summaryState.stale': 'Usang',
  'registries.summaryState.partial': 'Parsial',
  'registries.summaryState.blocked': 'Terblokir',
  'registries.summaryState.observed': 'Teramati',
  'registries.blocker.configRequiredTitle': 'Integrasi Core diperlukan',
  'registries.blocker.configMissingDescription':
    'Konfigurasi integrasi Core tidak ditemukan untuk pemeriksaan registri.',
  'registries.blocker.configInvalidTitle': 'Integrasi Core tidak valid',
  'registries.blocker.configInvalidDescription':
    'Konfigurasi integrasi Core saat ini tidak valid untuk pemeriksaan registri.',
  'registries.blocker.authRequiredTitle': 'Autentikasi Core diperlukan',
  'registries.blocker.authRequiredDescription':
    'Pemeriksaan registri tidak dapat melakukan autentikasi ke Core pada sesi ini.',
  'registries.blocker.forbiddenTitle': 'Pemeriksaan registri ditolak',
  'registries.blocker.forbiddenDescription':
    'Core menolak aktor ini untuk pemeriksaan registri tenant.',
  'registries.blocker.tenantUnavailableTitle': 'Tenant tidak tersedia',
  'registries.blocker.tenantUnavailableDescription':
    'Core melaporkan tenant ini sementara tidak tersedia untuk pemeriksaan registri.',
  'registries.blocker.tenantInvariantTitle': 'Pelanggaran invariant tenant',
  'registries.blocker.tenantInvariantDescription':
    'Core melaporkan pelanggaran invariant tenant untuk pemeriksaan registri.',
  'registries.blocker.genericDescription': 'Integrasi Core sedang memblokir pemeriksaan registri.',
  'registries.blocker.readOnly':
    'Layar ini hanya-baca dan tidak dapat menulis konfigurasi untuk Anda.',
  'registries.blocker.fixFlow':
    'Perbaiki koneksi Core di alur integrasi yang ada lalu coba lagi di sini.',
  'registries.collections.agents.title': 'Agent',
  'registries.collections.agents.description':
    'Catatan agent yang dipublikasikan. Tidak ada catatan yang dipilih otomatis.',
  'registries.collections.agents.loadMore': 'Muat lebih banyak agent',
  'registries.collections.toolDefinitions.title': 'Definisi',
  'registries.collections.toolDefinitions.description':
    'Kontrak tool yang dipublikasikan, terpisah dari pengaktifan izin.',
  'registries.collections.toolDefinitions.loadMore': 'Muat lebih banyak definisi',
  'registries.collections.toolEnablements.title': 'Pengaktifan',
  'registries.collections.toolEnablements.description':
    'Gerbang izin dan batas persetujuan runtime untuk tool.',
  'registries.collections.connectorTypes.title': 'Tipe',
  'registries.collections.connectorTypes.description':
    'Tipe connector yang dipublikasikan dan kontrak normalisasi.',
  'registries.collections.connectorTypes.loadMore': 'Muat lebih banyak tipe',
  'registries.collections.connectorBindings.title': 'Binding',
  'registries.collections.connectorBindings.description':
    'Akun penyedia yang terikat dan pilihan kemampuan.',
  'registries.collections.connectorBindings.loadMore': 'Muat lebih banyak binding',
  'registries.items.created': 'Dibuat {date}',
  'registries.items.fingerprint.config': 'Sidik konfigurasi {fingerprint}',
  'registries.items.fingerprint.definition': 'Definisi fp:{fingerprint}',
  'registries.items.fingerprint.type': 'Tipe fp:{fingerprint}',
  'registries.items.fingerprint.binding': 'Sidik ikatan {fingerprint}',
  'registries.items.meta.noAuditMode': 'Tanpa mode audit',
  'registries.items.meta.approvalRequired': 'Persetujuan diperlukan',
  'registries.items.meta.noApprovalGate': 'Tanpa gerbang persetujuan',
  'registries.items.status.noTenantEnablement': 'Tidak ada pengaktifan tenant yang dikembalikan',
  'registries.live.blocked': 'Peringatan: {title}. {description}',
  'registries.live.loaded': 'Tab {tab} aktif. {key} versi {version} dipilih.',
  'registries.live.loading': 'Tab {tab} aktif. Memuat {key} versi {version}.',
  'registries.live.idle': 'Tab {tab} aktif. Tidak ada detail yang dipilih.',
  'registries.drawer.title': 'Detail registri',
  'registries.drawer.eyebrow': 'Detail registri',
  'registries.collection.state.idle': 'Diam',
  'registries.collection.state.loading': 'Memuat',
  'registries.collection.state.observed': 'Teramati',
  'registries.collection.state.stale': 'Usang',
  'registries.collection.state.blocked': 'Terblokir',
  'registries.collection.body.idle': 'Menunggu pengamatan pertama.',
  'registries.collection.body.loading': 'Menyegarkan catatan yang tepat dari Core.',
  'registries.collection.body.empty': 'Diamati tanpa catatan yang dikembalikan.',
  'registries.collection.body.observedAt': 'Diamati pada {observedAt}.',
  'registries.collection.body.stale':
    'Diamati pada {observedAt}; penyegaran terakhir mempertahankan data baik terakhir.',
  'registries.collection.body.blocked': 'Core menolak koleksi ini untuk pemeriksaan.',
  'registries.collection.empty': 'Belum ada catatan tepat yang tersedia di koleksi ini.',
  'registries.detail.notAvailable': 'Tidak tersedia',
  'registries.detail.copyFingerprint': 'Salin fingerprint lengkap',
  'registries.detail.emptySchemaObject': 'Objek skema kosong',
  'registries.detail.schemaType': 'Tipe {type}',
  'registries.detail.schemaProperties': '{count} properti',
  'registries.detail.schemaRequired': '{count} wajib',
  'registries.detail.noFields': 'Tidak ada field',
  'registries.detail.fieldsSampleMore': '{count} field · {sample}…',
  'registries.detail.fieldsSample': '{count} field · {sample}',
  'registries.detail.noNormalizationContracts': 'Tidak ada kontrak normalisasi',
  'registries.detail.unresolved': 'Belum terselesaikan: {label}',
  'registries.detail.deferred': 'Muat tab target untuk memeriksa {label}.',
  'registries.detail.fingerprint.configuration': 'Fingerprint konfigurasi',
  'registries.detail.fingerprint.definition': 'Fingerprint definisi',
  'registries.detail.fingerprint.connectorType': 'Fingerprint tipe connector',
  'registries.detail.fingerprint.binding': 'Fingerprint binding',
  'registries.detail.section.agentLifecycle': 'Siklus hidup agent',
  'registries.detail.section.exactToolReferences': 'Referensi tool yang tepat',
  'registries.detail.section.logicalReferenceWarnings': 'Peringatan referensi logis',
  'registries.detail.section.configuration': 'Konfigurasi',
  'registries.detail.section.definitionLifecycle': 'Siklus hidup definisi',
  'registries.detail.section.schemas': 'Skema',
  'registries.detail.section.enablementLifecycle': 'Siklus hidup pengaktifan',
  'registries.detail.section.definitionLink': 'Tautan definisi',
  'registries.detail.section.typeLifecycle': 'Siklus hidup tipe',
  'registries.detail.section.contracts': 'Kontrak',
  'registries.detail.section.bindingLifecycle': 'Siklus hidup binding',
  'registries.detail.section.exactConnectorType': 'Tipe connector yang tepat',
  'registries.detail.section.logicalReferences': 'Referensi logis',
  'registries.detail.note.activeRecords':
    'Catatan aktif adalah status publikasi, bukan izin runtime.',
  'registries.detail.noExactToolRefs': 'Tidak ada referensi tool tepat yang dideklarasikan.',
  'registries.detail.note.logicalReferenceWarnings':
    'Referensi logis memerlukan tindak lanjut di luar tampilan hanya-baca ini.',
  'registries.detail.field.lifecycle': 'Siklus hidup',
  'registries.detail.field.owner': 'Pemilik',
  'registries.detail.field.created': 'Dibuat',
  'registries.detail.field.knowledgeScopes': 'Ruang lingkup pengetahuan',
  'registries.detail.field.riskPolicy': 'Kebijakan risiko',
  'registries.detail.none': 'Tidak ada',
  'registries.detail.field.effectClass': 'Kelas efek',
  'registries.detail.field.schemaVersion': 'Versi skema',
  'registries.detail.field.enablement': 'Pengaktifan',
  'registries.detail.field.inputSchema': 'Skema input',
  'registries.detail.field.outputSchema': 'Skema output',
  'registries.detail.field.timeoutDefaults': 'Batas waktu default',
  'registries.detail.field.retryContract': 'Kontrak retry',
  'registries.detail.field.auditContract': 'Kontrak audit',
  'registries.detail.viewRawJson': 'Lihat JSON mentah',
  'registries.detail.field.generation': 'Generasi',
  'registries.detail.field.approvalRequired': 'Persetujuan diperlukan',
  'registries.detail.field.auditMode': 'Mode audit',
  'registries.detail.notSet': 'Belum disetel',
  'registries.detail.field.timeoutCap': 'Batas timeout',
  'registries.detail.field.allowTtl': 'TTL yang diizinkan',
  'registries.detail.field.updated': 'Diperbarui',
  'registries.detail.note.enablementRecords':
    'Catatan pengaktifan menyatakan gerbang izin, bukan status publikasi definisi.',
  'registries.detail.field.sourceType': 'Tipe sumber',
  'registries.detail.field.capabilities': 'Kemampuan',
  'registries.detail.field.normalizationContracts': 'Kontrak normalisasi',
  'registries.detail.field.deliveryBehavior': 'Perilaku pengiriman',
  'registries.detail.field.providerAccountReference': 'Referensi akun penyedia',
  'registries.detail.note.logicalReferencesSecret':
    'Hanya referensi logis; rahasia tidak ditampilkan.',
  'registries.detail.field.configReference': 'Referensi konfigurasi',
  'registries.detail.field.credentialReference': 'Referensi kredensial',
  'registries.detail.empty': 'Pilih catatan untuk memeriksa versi registri yang tepat.',
  'registries.detail.state.loading': 'Memuat detail registri yang tepat...',
  ...
  'registries.detail.kind.connector-binding': 'Binding connector',
