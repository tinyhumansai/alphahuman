...
const messages: TranslationMap = {
  ...
  'home.coreRegistries': 'Core 레지스트리',
  'home.coreRegistriesDescription': 'Core의 정확한 에이전트, 도구, 커넥터 레코드를 확인합니다.',
  'home.coreRegistriesBlockedTitle': 'Core 통합이 필요합니다',
  'home.coreRegistriesBlockedMissingDescription':
    '레지스트리를 확인하기 전에 데스크톱 Core 통합을 완료하세요.',
  'home.coreRegistriesBlockedInvalidDescription':
    '레지스트리를 확인하기 전에 데스크톱 Core 통합을 복구하세요.',
  'home.coreRegistriesBlockedBridgeDescription':
    '레지스트리를 확인하기 전에 로컬 Core 브리지를 다시 연결하세요.',
  'home.coreRegistriesBlockedOfflineDescription':
    '레지스트리를 확인하기 전에 인터넷에 다시 연결하세요.',
  'registries.page.eyebrow': '레지스트리 보기',
  'registries.page.title': 'Core 레지스트리',
  'registries.page.description':
    'Core가 제공하는 정확한 에이전트, 도구, 커넥터 레코드를 읽기 전용으로 확인합니다.',
  'registries.page.readOnly': '이 화면은 구성, 비밀, 런타임 상태를 절대 쓰지 않습니다.',
  'registries.page.retry': '다시 시도',
  'registries.page.tablistAria': 'Core 레지스트리',
  'registries.tab.agents': '에이전트',
  'registries.tab.tools': '도구',
  'registries.tab.connectors': '커넥터',
  'registries.summaryState.idle': '대기',
  'registries.summaryState.loading': '불러오는 중',
  'registries.summaryState.fresh': '최신',
  'registries.summaryState.stale': '오래됨',
  'registries.summaryState.partial': '부분',
  'registries.summaryState.blocked': '차단됨',
  'registries.summaryState.observed': '관측됨',
  'registries.blocker.configRequiredTitle': 'Core 통합이 필요합니다',
  'registries.blocker.configMissingDescription':
    '레지스트리 확인에 필요한 Core 통합 구성을 찾을 수 없습니다.',
  'registries.blocker.configInvalidTitle': 'Core 통합이 잘못되었습니다',
  'registries.blocker.configInvalidDescription':
    '현재 Core 통합 구성이 레지스트리 확인에 유효하지 않습니다.',
  'registries.blocker.authRequiredTitle': 'Core 인증이 필요합니다',
  'registries.blocker.authRequiredDescription':
    '이 세션에서 레지스트리 확인이 Core 인증에 실패했습니다.',
  'registries.blocker.forbiddenTitle': '레지스트리 확인이 거부되었습니다',
  'registries.blocker.forbiddenDescription':
    'Core가 이 행위자의 테넌트 레지스트리 확인을 거부했습니다.',
  'registries.blocker.tenantUnavailableTitle': '테넌트를 사용할 수 없습니다',
  'registries.blocker.tenantUnavailableDescription':
    'Core가 이 테넌트는 현재 레지스트리 확인을 할 수 없다고 보고했습니다.',
  'registries.blocker.tenantInvariantTitle': '테넌트 불변식 위반',
  'registries.blocker.tenantInvariantDescription':
    'Core가 레지스트리 확인 중 테넌트 불변식 위반을 보고했습니다.',
  'registries.blocker.genericDescription': '현재 Core 통합이 레지스트리 확인을 막고 있습니다.',
  'registries.blocker.readOnly': '이 화면은 읽기 전용이므로 대신 구성을 쓸 수 없습니다.',
  'registries.blocker.fixFlow': '기존 통합 흐름에서 Core 연결을 고친 뒤 여기서 다시 시도하세요.',
  'registries.collections.agents.title': '에이전트',
  'registries.collections.agents.description':
    '게시된 에이전트 레코드입니다. 어떤 레코드도 자동 선택되지 않습니다.',
  'registries.collections.agents.loadMore': '에이전트 더 불러오기',
  'registries.collections.toolDefinitions.title': '정의',
  'registries.collections.toolDefinitions.description':
    '게시된 도구 계약이며 권한 활성화와 분리되어 있습니다.',
  'registries.collections.toolDefinitions.loadMore': '정의 더 불러오기',
  'registries.collections.toolEnablements.title': '활성화',
  'registries.collections.toolEnablements.description':
    '도구의 권한 게이트와 런타임 승인 한도입니다.',
  'registries.collections.connectorTypes.title': '유형',
  'registries.collections.connectorTypes.description': '게시된 커넥터 유형과 정규화 계약입니다.',
  'registries.collections.connectorTypes.loadMore': '유형 더 불러오기',
  'registries.collections.connectorBindings.title': '바인딩',
  'registries.collections.connectorBindings.description': '연결된 제공자 계정과 기능 선택입니다.',
  'registries.collections.connectorBindings.loadMore': '바인딩 더 불러오기',
  'registries.items.created': '생성일 {date}',
  'registries.items.fingerprint.config': '구성 지문 {fingerprint}',
  'registries.items.fingerprint.definition': '정의 fp:{fingerprint}',
  'registries.items.fingerprint.type': '유형 fp:{fingerprint}',
  'registries.items.fingerprint.binding': '바인딩 fp:{fingerprint}',
  'registries.items.meta.noAuditMode': '감사 모드 없음',
  'registries.items.meta.approvalRequired': '승인 필요',
  'registries.items.meta.noApprovalGate': '승인 게이트 없음',
  'registries.items.status.noTenantEnablement': '테넌트 활성화 레코드가 없습니다',
  'registries.live.blocked': '알림: {title}. {description}',
  'registries.live.loaded': '{tab} 탭 활성화됨. {key} 버전 {version} 선택됨.',
  'registries.live.loading': '{tab} 탭 활성화됨. {key} 버전 {version} 불러오는 중.',
  'registries.live.idle': '{tab} 탭 활성화됨. 선택된 세부 정보가 없습니다.',
  'registries.drawer.title': '레지스트리 세부 정보',
  'registries.drawer.eyebrow': '레지스트리 세부 정보',
  'registries.collection.state.idle': '대기',
  'registries.collection.state.loading': '불러오는 중',
  'registries.collection.state.observed': '관측됨',
  'registries.collection.state.stale': '오래됨',
  'registries.collection.state.blocked': '차단됨',
  'registries.collection.body.idle': '첫 관측을 기다리는 중입니다.',
  'registries.collection.body.loading': 'Core에서 정확한 레코드를 새로 고치는 중입니다.',
  'registries.collection.body.empty': '관측은 되었지만 반환된 레코드가 없습니다.',
  'registries.collection.body.observedAt': '{observedAt}에 관측되었습니다.',
  'registries.collection.body.stale':
    '{observedAt}에 관측됨. 마지막 새로 고침은 마지막 정상 데이터를 유지했습니다.',
  'registries.collection.body.blocked': 'Core가 이 컬렉션의 확인을 거부했습니다.',
  'registries.collection.empty': '이 컬렉션에는 아직 정확한 레코드가 없습니다.',
  'registries.detail.notAvailable': '사용할 수 없음',
  'registries.detail.copyFingerprint': '전체 지문 복사',
  'registries.detail.emptySchemaObject': '빈 스키마 객체',
  'registries.detail.schemaType': '유형 {type}',
  'registries.detail.schemaProperties': '{count}개 속성',
  'registries.detail.schemaRequired': '{count}개 필수',
  'registries.detail.noFields': '필드 없음',
  'registries.detail.fieldsSampleMore': '{count}개 필드 · {sample}…',
  'registries.detail.fieldsSample': '{count}개 필드 · {sample}',
  'registries.detail.noNormalizationContracts': '정규화 계약 없음',
  'registries.detail.unresolved': '해결되지 않음: {label}',
  'registries.detail.deferred': '{label}을 확인하려면 대상 탭을 먼저 불러오세요.',
  'registries.detail.fingerprint.configuration': '구성 지문',
  'registries.detail.fingerprint.definition': '정의 지문',
  'registries.detail.fingerprint.connectorType': '커넥터 유형 지문',
  'registries.detail.fingerprint.binding': '바인딩 지문',
  'registries.detail.section.agentLifecycle': '에이전트 수명 주기',
  'registries.detail.section.exactToolReferences': '정확한 도구 참조',
  'registries.detail.section.logicalReferenceWarnings': '논리 참조 경고',
  'registries.detail.section.configuration': '구성',
  'registries.detail.section.definitionLifecycle': '정의 수명 주기',
  'registries.detail.section.schemas': '스키마',
  'registries.detail.section.enablementLifecycle': '활성화 수명 주기',
  'registries.detail.section.definitionLink': '정의 링크',
  'registries.detail.section.typeLifecycle': '유형 수명 주기',
  'registries.detail.section.contracts': '계약',
  'registries.detail.section.bindingLifecycle': '바인딩 수명 주기',
  'registries.detail.section.exactConnectorType': '정확한 커넥터 유형',
  'registries.detail.section.logicalReferences': '논리 참조',
  'registries.detail.note.activeRecords':
    '활성 레코드는 게시 상태이며 런타임 권한 부여가 아닙니다.',
  'registries.detail.noExactToolRefs': '정확한 도구 참조가 선언되지 않았습니다.',
  'registries.detail.note.logicalReferenceWarnings':
    '논리 참조는 이 읽기 전용 화면 밖에서 추가 확인이 필요합니다.',
  'registries.detail.field.lifecycle': '수명 주기',
  'registries.detail.field.owner': '소유자',
  'registries.detail.field.created': '생성됨',
  'registries.detail.field.knowledgeScopes': '지식 범위',
  'registries.detail.field.riskPolicy': '위험 정책',
  'registries.detail.none': '없음',
  'registries.detail.field.effectClass': '효과 등급',
  'registries.detail.field.schemaVersion': '스키마 버전',
  'registries.detail.field.enablement': '활성화',
  'registries.detail.field.inputSchema': '입력 스키마',
  'registries.detail.field.outputSchema': '출력 스키마',
  'registries.detail.field.timeoutDefaults': '기본 타임아웃',
  'registries.detail.field.retryContract': '재시도 계약',
  'registries.detail.field.auditContract': '감사 계약',
  'registries.detail.viewRawJson': '원시 JSON 보기',
  'registries.detail.field.generation': '세대',
  'registries.detail.field.approvalRequired': '승인 필요',
  'registries.detail.field.auditMode': '감사 모드',
  'registries.detail.notSet': '설정되지 않음',
  'registries.detail.field.timeoutCap': '타임아웃 상한',
  'registries.detail.field.allowTtl': '허용 TTL',
  'registries.detail.field.updated': '업데이트됨',
  'registries.detail.note.enablementRecords':
    '활성화 레코드는 정의의 게시 상태가 아니라 권한 게이트를 나타냅니다.',
  'registries.detail.field.sourceType': '소스 유형',
  'registries.detail.field.capabilities': '기능',
  'registries.detail.field.normalizationContracts': '정규화 계약',
  'registries.detail.field.deliveryBehavior': '전달 동작',
  'registries.detail.field.providerAccountReference': '제공자 계정 참조',
  'registries.detail.note.logicalReferencesSecret': '논리 참조만 표시되며 비밀은 보이지 않습니다.',
  'registries.detail.field.configReference': '구성 참조',
  'registries.detail.field.credentialReference': '자격 증명 참조',
  'registries.detail.empty': '정확한 레지스트리 버전을 확인할 레코드를 선택하세요.',
  'registries.detail.state.loading': '정확한 레지스트리 세부 정보를 불러오는 중...',
  'registries.detail.state.missing': 'Core가 이 정확한 레코드 버전은 더 이상 없다고 보고했습니다.',
  'registries.detail.state.error': 'Core가 지금 이 정확한 레코드를 불러올 수 없습니다.',
  'registries.detail.kind.agent': '에이전트',
  'registries.detail.kind.tool-definition': '도구 정의',
  'registries.detail.kind.tool-enablement': '도구 활성화',
  'registries.detail.kind.connector-type': '커넥터 유형',
  'registries.detail.kind.connector-binding': '커넥터 바인딩',
